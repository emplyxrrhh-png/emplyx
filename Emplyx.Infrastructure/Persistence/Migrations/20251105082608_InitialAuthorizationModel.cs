...
{
    /// <inheritdoc />
    public partial class InitialAuthorizationModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0ad1bc87-5e61-4258-8f51-2305b7c5401d"), new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Acceso general sin restricciones.", true, 1, "Público", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    ...
                    { new Guid("5d7a9d25-c4b2-4b93-93c6-a39c47da1f40"), new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Acceso reservado a datos confidenciales y críticos.", true, 3, "Restringido", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) }
                });

            migrationBuilder.InsertData(
                table: "Delegaciones",
                columns: new[] { "Id", "Codigo", "CreatedAtUtc", "Descripcion", "IsActive", "Nombre", "ParentId", "UpdatedAtUtc" },
                values: new object[] { new Guid("8f9033a5-436b-4e1f-9d05-21c27c6c3bf2"), "CENTRAL", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Sede central corporativa.", true, "Delegación Central", null, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) });
            ...
            migrationBuilder.InsertData(
                table: "Permisos",
                columns: new[] { "Id", "Categoria", "Codigo", "CreatedAtUtc", "EsCritico", "Modulo", "Nombre", "UpdatedAtUtc" },
                values: new object[] { new Guid("76d8cc5f-4224-4ef3-a594-984cd5c50a62"), "Roles", "SEGURIDAD.ROLES.GESTIONAR", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, "Seguridad", "Gestionar roles", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) });

            migrationBuilder.InsertData(
                table: "Permisos",
                columns: new[] { "Id", "Categoria", "Codigo", "CreatedAtUtc", "Modulo", "Nombre", "UpdatedAtUtc" },
                values: new object[] { new Guid("8fe47fa7-0fc5-4dae-b426-2e1dd7d5e47c"), "Usuarios", "SEGURIDAD.USUARIOS.VER", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Seguridad", "Ver usuarios", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("c5e0a3ea-4fe8-4f8c-a2a0-3cfc4fb28eb1"), "Licencias", "OPERACIONES.LICENCIAS.GESTIONAR", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, "Operaciones", "Gestionar licencias", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { new Guid("d854df08-26d2-4af7-98d3-49816d23c01f"), "Contextos", "OPERACIONES.CONTEXTOS.GESTIONAR", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, "Operaciones", "Gestionar contextos", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) }
                });

            migrationBuilder.InsertData(
                table: "Permisos",
                columns: new[] { "Id", "Categoria", "Codigo", "CreatedAtUtc", "Modulo", "Nombre", "UpdatedAtUtc" },
                values: new object[] { new Guid("dc6c8079-0af4-4a35-86d6-c9f6a4541bc9"), "Contextos", "OPERACIONES.CONTEXTOS.VER", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Operaciones", "Ver contextos", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) });

            migrationBuilder.InsertData(
                table: "Permisos",
                columns: new[] { "Id", "Categoria", "Codigo", "CreatedAtUtc", "EsCritico", "Modulo", "Nombre", "UpdatedAtUtc" },
                values: new object[] { new Guid("f1d2c6fe-39f8-4832-9e2d-468f4bea7c31"), "Usuarios", "SEGURIDAD.USUARIOS.GESTIONAR", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, "Seguridad", "Gestionar usuarios", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAtUtc", "Descripcion", "IsSystem", "Nombre", "UpdatedAtUtc" },
                values: new object[,]
                {
                    { new Guid("3fbdede0-0773-4cb6-9881-9350d0f4955e"), new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Acceso total a la plataforma.", true, "Administrador Global", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { new Guid("a43b4a24-9d24-4c51-94f0-d5e8b9d7eaf4"), new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Gestiona recursos dentro de su delegación.", false, "Gestor de Delegación", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { new Guid("a9d6d2dc-136f-42e4-9b77-75568128ed5f"), new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Operativa diaria de la plataforma.", false, "Operador", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d84145b9-4a7f-4ea9-8b0c-d4b0f8f6c424"), "NORTE", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Operaciones regionales zona norte.", true, "Delegación Regional Norte", new Guid("8f9033a5-436b-4e1f-9d05-21c27c6c3bf2"), new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { new Guid("e4d8d94a-9084-46c3-99c1-1b4ef76e6a19"), "SUR", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Operaciones regionales zona sur.", true, "Delegación Regional Sur", new Guid("8f9033a5-436b-4e1f-9d05-21c27c6c3bf2"), new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
