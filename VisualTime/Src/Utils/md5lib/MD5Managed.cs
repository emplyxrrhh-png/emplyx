namespace ZK.MD5
{
    ...
    public class MD5Managed : HashAlgorithm
    {
        ...
        public void HashCoreEx(byte[] array, int ibStart, int cbSize)
        {
            if (null == array)
            {
                throw new ArgumentNullException(nameof(array));
        ...
        public static void MD5Update(MD5_CTX context,  /* context */
