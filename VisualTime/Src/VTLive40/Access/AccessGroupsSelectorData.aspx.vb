...
Partial Class AccessGroupsSelectorData
...
#Region "Declarations"
    ...
    Private strIconAccessGroups As String = "AccessGroups_16.png"
    ...
    Private bolFilterConceptAccessGroups As Boolean = True
...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Me.strImagesPath = "../../images/AccessGroupsSelector"
        End If
        ...
        If Filters <> "" Then
            If Filters.Substring(0, 1) = "1" Then Me.bolFilterConceptAccessGroups = True Else Me.bolFilterConceptAccessGroups = False
        End If

        If ViewState("AccessGroupsSelector_Selection") IsNot Nothing Then
            Dim strSelection As String = ViewState("AccessGroupsSelector_Selection")
...
#Region "Methods"
    ...
    Private Sub LoadAccessGroupsTree()

        Dim dTbl As DataTable = If((HelperSession.AdvancedParametersCache("AccessGroupsMode").Equals("1")), API.AccessGroupServiceMethods.GetAccessGroupsByPassportDataTable(Me.Page, WLHelperWeb.CurrentPassportID, False), API.AccessGroupServiceMethods.GetAccessGroups(Me.Page))
        ...
        If dTbl.Rows.Count > 0 Then
            For Each dRow As DataRow In dTbl.Rows
                ...
                strArrayNodes &= "{ 'id':'" & dRow("ID") & "', 'text':'" & dRow("Name").Replace("'", "&#39;") & "', " &
                                 "'leaf': true, " &
                                 "'icon': '" & Me.strImagesPath & strIconAccessGroups & "'"
                strArrayNodes &= "},"
                'End If
            Next
        End If
