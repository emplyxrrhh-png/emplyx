...
Partial Class AccessPeriodsSelectorData
...
#Region "Declarations"
    ...
    Private strIconAccessPeriods As String = "AccessPeriods_16.png"
    ...
    Private bolFilterConceptAccessPeriods As Boolean = True
...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Me.strImagesPath = "../../images/AccessPeriodsSelector"
        End If
        ...
        If Filters <> "" Then
            If Filters.Substring(0, 1) = "1" Then Me.bolFilterConceptAccessPeriods = True Else Me.bolFilterConceptAccessPeriods = False
        End If

        If ViewState("AccessPeriodsSelector_Selection") IsNot Nothing Then
            Dim strSelection As String = ViewState("AccessPeriodsSelector_Selection")
...
#Region "Methods"
    ...
    Private Sub LoadAccessPeriodsTree()

        Dim dTbl As DataTable = API.AccessPeriodServiceMethods.GetAccessPeriods(Me.Page)
        ...
        If dTbl.Rows.Count > 0 Then
            For Each dRow As DataRow In dTbl.Rows
                ...
                strArrayNodes &= "{ 'id':'" & dRow("ID") & "', 'text':'" & dRow("Name").Replace("'", "&#39;") & "', " &
                                 "'leaf': true, " &
                                 "'icon': '" & Me.strImagesPath & strIconAccessPeriods & "'"
                strArrayNodes &= "},"
                'End If
            Next
        End If
