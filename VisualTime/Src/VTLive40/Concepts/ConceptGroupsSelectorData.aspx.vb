...
Partial Class ConceptsGroupSelectorData
...
#Region "Declarations"
    ...
    Private strIconConcept As String = "ConceptGroup_16.png"
    Private strIconConceptOld As String = "ConceptGroup_16_old.png"
...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Me.strImagesPath = "../../images/ConceptGroupsSelector"
        End If
        ...
        If Session("ConceptGroupSelector_Selection") IsNot Nothing Then
            Dim strSelection As String = Session("ConceptGroupSelector_Selection")
...
#Region "Methods"
    ...
    Private Sub LoadConceptGroupsTree()

        ' Obtenemos los grupos
        Dim dTbl As DataTable = API.ConceptsServiceMethods.GetConceptsGroups(Me.Page, False)
