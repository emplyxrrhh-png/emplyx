...
Partial Class ConceptsSelectorData
...
#Region "Declarations"
    ...
    Private strIconConcept As String = "Concept_16.png"
    Private strIconConceptOld As String = "Concept_16_old.png"
...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Me.strImagesPath = "../../images/ConceptSelector"
        End If
        ...
        If Session("ConceptSelector_Selection") IsNot Nothing Then
            Dim strSelection As String = Session("ConceptSelector_Selection")
    ...
    Private Sub LoadConceptsTree()
        ...
        If dtOrderer.Rows.Count > 0 Then
            For Each dRow As DataRow In dtOrderer.Rows
                Dim strIco As String = strIconConcept
                If dRow("FinishDate") IsNot Nothing Then
                    If dRow("FinishDate") < Date.Now Then
                        strIco = strIconConceptOld
                    End If
                End If
