...
Partial Class Indicators_IndicatorsSelectorData
...
#Region "Declarations"
    ...
    Private strIconIndicator As String = "Indicators16.png"
    ...
    Private bolFilterIndicator As Boolean = True
...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Filters <> "" Then
            If Filters.Substring(0, 1) = "1" Then Me.bolFilterIndicator = True Else Me.bolFilterIndicator = False
        End If

        If Session("IndicatorsSelector_Selection") IsNot Nothing Then
            Dim strSelection As String = Session("IndicatorsSelector_Selection")
...
#Region "Methods"
    ...
    Private Sub LoadIndicatorsTree()

        Dim dTbl As DataTable = API.IndicatorsServiceMethods.GetIndicatorsDataTable(IndicatorsType.Attendance, Me.Page, "", True)

        Dim dtOrderer As DataTable = Nothing
        If dTbl.Rows.Count > 0 Then
            Dim query = From c In dTbl.AsEnumerable
                        Order By c.Field(Of String)("Name") Ascending
            dtOrderer = query.CopyToDataTable
        Else
            dtOrderer = dTbl
        End If

        If dtOrderer.Rows.Count > 0 Then
            For Each dRow As DataRow In dtOrderer.Rows
                ...
                strArrayNodes &= "{ 'id':'" & dRow("ID") & "', 'text':'" & dRow("Name").Replace("'", "&#39;") & "', " &
                                 "'leaf': true, " &
                                 "'icon': '" & Me.strImagesPath & strIconIndicator & "'"
                strArrayNodes &= "},"
                'End If
            Next
        End If
