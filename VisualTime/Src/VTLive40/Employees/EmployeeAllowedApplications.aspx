<%@ Page Language="VB" AutoEventWireup="false" Inherits="VTLive40.Forms_EmployeeAllowedApplications" Culture="auto" UICulture="auto" EnableViewState="True" CodeBehind="EmployeeAllowedApplications.aspx.vb" %>
        ...
        <div class="DetailFrame_TopMid">
            ...
            <script type="text/javascript">
                ...
                function CheckFields() {
                    ...
                    if (CheckConvertControls('') == true) {
                        ...
                        bolRet = false;
                        var message = "TitleKey=SaveEmployeeAllowedApplications.Check.Invalid.Text&" +
                            "DescriptionKey=SaveEmployeeAllowedApplications.Check.Invalid.Description&" +
                            "Option1TextKey=SaveEmployeeAllowedApplications.Check.Invalid.Option1Text&" +
                            "Option1DescriptionKey=SaveEmployeeAllowedApplications.Check.Invalid.Option1Description&" +
            ...
            <div style="width: 100%; padding-top: 10px;">
                <div class="panHeader2">
                    <span style="">
                        <asp:Label ID="lblTitle" runat="server" Text="Aplicaciones permitidas"></asp:Label></span>
                </div>
            </div>
            <div style="background-color: Transparent">
                <table cellpadding="0" cellspacing="0" style="padding-top: 10px;">
                    ...
                    <tr>
                        <td style="height: 355px; padding-left: 8px; padding-top: 5px; vertical-align: top;">
                            <asp:UpdatePanel ID="updEmployeeIdentifyMethods" runat="server">
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="RoundCorner" style="border: thin solid silver; width: 630px; height: auto;">
                                        <roUserControls:AllowedApplications ID="cnAllowedApplications" ModoWizardNew="ModeNormal" Type="Employee" runat="server" />
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
