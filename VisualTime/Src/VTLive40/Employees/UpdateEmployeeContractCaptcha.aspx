<%@ Page Language="VB" AutoEventWireup="false" Inherits="VTLive40.Employees_UpdateEmployeeContractCaptcha" CodeBehind="UpdateEmployeeContractCaptcha.aspx.vb" %>
    ...
    <script type="text/javascript">
        ...
        function AcceptClick() {
            ...
            if (inputCaptcha == userCaptcha) {
                window.parent.UpdateContractRowExec();
                window.parent.PopupCaptcha_Client.SetContentUrl('');
                window.parent.PopupCaptcha_Client.Hide();
            } else {
                ...
                window.parent.parent.ShowMsgBoxForm(url, 500, 300, '');
                            ...
                            <tr>
                                <td style="padding-top: 5px; padding-bottom: 10px;" height="20px" valign="top">
                                    <div class="panHeader2">
                                        <span style="">
                                            <asp:Label ID="lblTitle" runat="server" Text="Actualizar contrato"></asp:Label></span>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td align="left" valign="middle">
                                                <asp:Label ID="lblDescription1" runat="server" CssClass="editTextFormat" Text="Se dispone a actualizar el contrato, borrará todos los datos que puedan existir de este ${Employee} desde ${Criteria.TheDate} de baja que le ha ${Assignment}."></asp:Label>
                                                <br />
