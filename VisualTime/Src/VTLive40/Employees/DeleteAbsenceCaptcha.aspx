<%@ Page Language="VB" AutoEventWireup="false" Inherits="VTLive40.Employees_DeleteAbsenceCaptcha" CodeBehind="DeleteAbsenceCaptcha.aspx.vb" %>
    ...
    <script type="text/javascript">
        ...
        function AcceptClick(s, e) {
            ...
            if (inputCaptcha != userCaptcha) {
                ...
                var execParams = document.getElementById("hdnJsType").value.split(",");

                if (execParams[0] == "0") {
                    window.parent.frames["ifPrincipal"].removeGridAus(parseInt(execParams[1], 10), parseInt(execParams[2], 10), execParams[3]);
                } else if (execParams[0] == "1") {
                    window.parent.frames["ifPrincipal"].removeGridInc(parseInt(execParams[1], 10), parseInt(execParams[2], 10), execParams[3], parseInt(execParams[4], 10));
                } else if (execParams[0] == "2") {
                    window.parent.frames["ifPrincipal"].removeGridHolidays(parseInt(execParams[1], 10));
                } else if (execParams[0] == "3") {
                    window.parent.frames["ifPrincipal"].removeGridOvertimes(parseInt(execParams[1], 10));
                }
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="hdnJsType" runat="server" />
            ...
            <tr>
                <td style="padding-top: 5px; padding-bottom: 10px;" height="20px" valign="top">
                    <div class="panHeader2">
                        <span style="">
                            <asp:Label ID="lblTitle" runat="server" Text="Eliminar ausencia"></asp:Label></span>
                    </div>
                </td>
            </tr>
                    ...
                    <table>
                        <tr>
                            ...
                            <td align="left" valign="middle">
                                <asp:Label ID="lblDescription1" runat="server" CssClass="editTextFormat" Text="Se dispone a eliminar la ausencia y todos sus registros de seguimiento"></asp:Label>
                                <br />
