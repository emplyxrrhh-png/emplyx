<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="DocumentManagment.ascx.vb" Inherits="VTLive40.DocumentManagment" %>
...
<script type="text/javascript">
    ...
    function <%= Me.ClientID %>_PerformAction() {
        ...
        var pendingControl = pendingDocName.replace("DocumentManagment", "DocumentPendingManagment");
...
<dx:ASPxPopupControl ID="EditDocumentPopup" runat="server" AllowDragging="False" CloseAction="None" Modal="True" ContentUrl="~/Employees/EditDocument.aspx"
    PopupVerticalAlign="WindowCenter" PopupHorizontalAlign="WindowCenter" Width="900px" Height="550px"
