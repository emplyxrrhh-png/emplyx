...
Partial Class Tasks_BusinessCentersSelectorData
...
#Region "Declarations"
    ...
    Private strIconBusinessCenters As String = "BusinessCenters_16.png"
    ...
    Private bolFilterBusinessCenters As Boolean = True
...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Me.strImagesPath = "../../images/BusinessCentersSelector"
        End If
        ...
        If Filters <> "" Then
            If Filters.Substring(0, 1) = "1" Then Me.bolFilterBusinessCenters = True Else Me.bolFilterBusinessCenters = False
        End If

        If Session("BusinessCentersSelector_Selection") IsNot Nothing Then
            Dim strSelection As String = Session("BusinessCentersSelector_Selection")
        ...
        If Session("TreeFilter") IsNot Nothing Then
            Dim strSession = Session("TreeFilter")
            strFilter = strSession.ToString().Split("|")(0)
        End If

        Select Case Me.strAction
            Case "TreeData" ' Obtiene los nodos del árbol del nivel indicado (strParent)

                LoadBusinessCentersTree(strFilter)
...
#Region "Methods"
    ...
    Private Sub LoadBusinessCentersTree(Optional filter As String = "")

        Dim dTbl As DataTable = If(String.IsNullOrEmpty(filter), API.TasksServiceMethods.GetBusinessCenters(Page, False), API.TasksServiceMethods.GetBusinessCentersByFilter(Page, filter))
            ...
            If dTbl.Rows.Count > 0 Then
                For Each dRow As DataRow In dTbl.Rows
                    ...
                    strArrayNodes &= "{ 'id':'" & dRow("ID") & "', 'text':'" & dRow("Name").Replace("'", "&#39;") & "', " &
                                     "'leaf': true, " &
                                     "'icon': '" & Me.strImagesPath & strIconBusinessCenters & "'"
                    strArrayNodes &= "},"
                    'End If
                Next
            End If
