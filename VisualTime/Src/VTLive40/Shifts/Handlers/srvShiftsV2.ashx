...
#Region "Methods"
    ...
    Private Function CreateTabs(ByVal intActiveTab As Integer) As HtmlTable
        ...
        oTabButtons(1) = CreateNewHtmlAnchor("TABBUTTON_01", Me.Language.Translate("tabAdvanced", Me.DefaultScope), "bTab")
        ...
        oTabButtons(2) = CreateNewHtmlAnchor("TABBUTTON_02", Me.Language.Translate("tabRules", Me.DefaultScope), "bTab")
