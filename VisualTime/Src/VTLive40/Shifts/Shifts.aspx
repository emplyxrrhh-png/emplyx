<%@ Page Language="VB" MasterPageFile="~/Base/mastEmp.master" AutoEventWireup="false" Inherits="VTLive40.Shifts" Title="${Shifts}" EnableEventValidation="false" CodeBehind="Shifts.aspx.vb" %>
...
<%@ Register Src="~/Shifts/WebUserForms/frmAddAssignment.ascx" TagName="frmAddAssignment" TagPrefix="roForms" %>
...
<asp:Content ID="cMainBody" ContentPlaceHolderID="contentMainBody" runat="Server">
                                ...
                                <div id="divContentPanels" class="divContentPanelsWithOutMessage">
                                    ...
                                    <div id="ShiftsContent" runat="server" class="contentPanel" style="display: none">
                                        ...
                                        <div id="div00" class="contentPanel" style="display: none" runat="server" name="menuPanel">
                                            ...
                                            <div id="divWorkDayStartBefore" runat="server" class="panBottomMargin">
                                                <div class="panHeader2">
                                                    <span style="">
                                                        <asp:Label runat="server" ID="lblWorkdayStartBefore" Text="Configuración de inicio de la jornada"></asp:Label></span>
                                                </div>
                                                <br />
                                                <div class="divRow">
                                                    <div style="float: left; clear: both">
                                                        <dx:ASPxCheckBox ID="ckWorkdayStartBefore" ClientInstanceName="ckWorkdayStartBeforeClient" runat="server" Text="Recordar al ">
                                                            <ClientSideEvents CheckedChanged="function(s,e){ hasChanges(true,false); enableDisableCmbWorkdayStartBefore();}" />
                                                        </dx:ASPxCheckBox>
                                                    </div>
                                                    <div style="float: left; padding-left: 10px">
                                                        <dx:ASPxComboBox runat="server" ID="cmbWorkdayStartBefore" EnableClientSideAPI="true" ClientInstanceName="cmbWorkdayStartBefore" Width="250px">
                                                            <ClientSideEvents SelectedIndexChanged="function(s,e){hasChanges(true,false);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                        </dx:ASPxComboBox>
                                                    </div>
                                                    <div style="float: left; padding-left: 10px">
                                                        <dx:ASPxLabel ID="lblWorkdayStartBefore2" CssClass="roLabel" ClientInstanceName="lblWorkdayStartBefore2Client" runat="server" Text=" que no puede iniciar su jornada " />
                                                    </div>
                                                    <div style="float: left; padding-left: 10px">
                                                        <dx:ASPxTimeEdit ID="dtWorkdayStartBefore" ClientInstanceName="dtWorkdayStartBeforeClient" EditFormatString="HH:mm" EditFormat="Custom" runat="server" Width="85px" AllowNull="false">
                                                            <ClientSideEvents GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" DateChanged="function(s,e){ hasChanges(true,false)}" />
                                                        </dx:ASPxTimeEdit>
                                                    </div>
                                                    <div style="float: left; padding-left: 10px">
                                                        <dx:ASPxLabel ID="lblWorkdayStartBefore3" CssClass="roLabel" ClientInstanceName="ckWorkdayStartBefore3Client" runat="server" Text=" antes de su hora prevista, a no ser que tenga una previsión autorizada de exceso de jornada" />
                                                    </div>
                                                </div>
                                                <div class="divRow">
                                                    <div style="float: left; clear: both">
                                                        <dx:ASPxCheckBox ID="ckWorkdayStartAfter" ClientInstanceName="ckWorkdayStartAfterClient" runat="server" Text="Si ">
                                                            <ClientSideEvents CheckedChanged="function(s,e){ hasChanges(true,false); enableDisableCmbWorkdayStartAfter(); }" />
                                                        </dx:ASPxCheckBox>
                                                    </div>
                                                    <div style="float: left; padding-left: 10px">
                                                        <dx:ASPxTimeEdit ID="dtWorkdayStartAfter" ClientInstanceName="dtWorkdayStartAfterClient" EditFormatString="HH:mm" EditFormat="Custom" runat="server" Width="85px" AllowNull="false">
                                                            <ClientSideEvents GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" DateChanged="function(s,e){ hasChanges(true,false)}" />
                                                        </dx:ASPxTimeEdit>
                                                    </div>
                                                    <div style="float: left; padding-left: 10px">
                                                        <dx:ASPxLabel ID="lblWorkdayStartAfter2" CssClass="roLabel" ClientInstanceName="lblWorkdayStartAfter2Client" runat="server" Text=" de la hora prevista no has iniciado tu jornada, recordar al  " />
                                                    </div>
                                                    <div style="float: left; padding-left: 10px">
                                                        <dx:ASPxComboBox runat="server" ID="cmbWorkdayStartAfter" EnableClientSideAPI="true" ClientInstanceName="cmbWorkdayStartAfter" Width="250px">
                                                            <ClientSideEvents SelectedIndexChanged="function(s,e){hasChanges(true,false);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                        </dx:ASPxComboBox>
                                                    </div>

                                                    <div style="float: left; padding-left: 10px">
                                                        <dx:ASPxLabel ID="lblWorkdayStartAfter3" CssClass="roLabel" ClientInstanceName="ckWorkdayStartAfter3Client" runat="server" Text=" que debe registrar su inicio de jornada" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="panBottomMargin">
                                                <div class="panHeader2">
                                                    <span style="">
                                                        <asp:Label runat="server" ID="lblBehaviour" Text="Alertas y comportamiento"></asp:Label></span>
                                                </div>
                                                <br />
                                                <div class="divRow">
                                                    <div class="" style="padding-bottom: 10px; font-style: italic;">
                                                        <asp:Label ID="lblPuinchAtInfo" runat="server" Text="Solo aplicable en horarios con franjas que inicien y finalicen el mismo"></asp:Label>
                                                    </div>
                                                    <div style="float: left; clear: both">
                                                        <dx:ASPxCheckBox ID="ckNotifyEmployeeExit" ClientInstanceName="ckNotifyEmployeeExitClient" runat="server" Text="Recordar al usuario que debe tener autorización a las">
                                                            <ClientSideEvents CheckedChanged="function(s,e){ enableNotifyRelated(s,e); hasChanges(true,false); }" />
                                                        </dx:ASPxCheckBox>
                                                    </div>
                                                    <div style="float: left; padding-left: 10px">
                                                        <dx:ASPxTimeEdit ID="dtNotifyEmployeeExit" ClientInstanceName="dtNotifyEmployeeExitClient" EditFormatString="HH:mm" EditFormat="Custom" runat="server" Width="85px" AllowNull="false">
                                                            <ClientSideEvents GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" DateChanged="function(s,e){ hasChanges(true,false)}" />
                                                        </dx:ASPxTimeEdit>
                                                    </div>
                                                    <div style="float: left; padding-left: 10px">
                                                        <dx:ASPxLabel ID="ckNotifyEmployeeDesc" CssClass="roLabel" ClientInstanceName="ckNotifyEmployeeDescClient" runat="server" Text="si se sigue trabajando" />
                                                    </div>
                                                    <div class="divRow" style="margin-left: 20px;">
                                                        <div style="float: left">
                                                            <dx:ASPxCheckBox ID="ckPunchAtTime" ClientInstanceName="ckPunchAtTimeClient" runat="server" Text="Completar automáticamente la salida ">
                                                                <ClientSideEvents CheckedChanged="function(s,e){ hasChanges(true,false)}" />
                                                            </dx:ASPxCheckBox>
                                                        </div>
                                                        <div style="float: left; padding-left: 10px">
                                                            <dx:ASPxTimeEdit ID="dtPunchAtTime" ClientInstanceName="dtPunchAtTimeClient" EditFormatString="HH:mm" EditFormat="Custom" runat="server" Width="85px" AllowNull="false">
                                                                <ClientSideEvents GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" DateChanged="function(s,e){ hasChanges(true,false)}" />
                                                            </dx:ASPxTimeEdit>
                                                        </div>
                                                        <div style="float: left; padding-left: 10px">
                                                            <dx:ASPxLabel ID="CkPunchAtTimeDesc" CssClass="roLabel" ClientInstanceName="CkPunchAtTimeDescClient" runat="server" Text="si el usuario no ha fichado" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="div02" class="contentPanel" style="display: none" runat="server" name="menuPanel">
                                                                    ...
                                                                    <tbody>
                                                                                    ...
                                                                                    <div id="toolbarDefinition" runat="server" style="float: right">
                                                                                        <div class="jsgridButton">
                                                                                            <div class="btnFlat">
                                                                                                ...
                                                                                                <div id="divFloatMenu" class="floatMenu defaultBackgroundColor" style="display: none;" onmouseover="document.getElementById('divFloatMenu').style.display='';" onmouseout="document.getElementById('divFloatMenu').style.display='none';">
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" style="padding-top: 15px;">
                                                                                <div style="width: 628px; text-align: left;">
                                                                                    <asp:Label ID="lblParmG" Font-Bold="true" runat="server" Text="Parametros Generales"></asp:Label>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="left">
                                                                                <div style="width: 628px; margin-top: 15px;">
                                                                                    <roUserControls:roTabContainerClient ID="tabCtl01" runat="server">
                                                                                        <TabTitle1>
                                                                                            <asp:Label ID="lblTotalDiarys" runat="server" Text="Totales diarios"></asp:Label>
                                                                                        </TabTitle1>
                                                                                        <TabContainer1>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <table>
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    <asp:Label ID="lblTotHorPrev" runat="server" Text="El total de horas previsto para este ${Shift} es de:"></asp:Label>&nbsp;&nbsp;</td>
                                                                                                                <td>
                                                                                                        ...
                                                                                                        <table border="0" style="height: 12px;">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td style="width: 75px; height: 22px;">
                                                                                                                    <dx:ASPxTimeEdit ID="txtTotTimeNoLleg1" runat="server" Width="85px" EditFormatString="HH:mm" EditFormat="Custom" ClientInstanceName="txtTotTimeNoLleg1Client">
                                                                                                                        <ClientSideEvents DateChanged="function(s,e){hasChanges(true,true);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                                                                                    </dx:ASPxTimeEdit>
                                                                                                                </td>
                                                                                                                <td>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    <table>
                                                                                                                        <tr>
                                                                                                                            ...
                                                                                                                            <td style="width: 75px; height: 22px;">
                                                                                                                                <dx:ASPxTimeEdit ID="txtTotTimeNoSup" runat="server" Width="85px" EditFormatString="HH:mm" EditFormat="Custom" ClientInstanceName="txtTotTimeNoSupClient">
                                                                                                                                    <ClientSideEvents DateChanged="function(s,e){hasChanges(true,true);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                                                                                                </dx:ASPxTimeEdit>
                                                                                                                            </td>
                                                                                                                            <td>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <dx:ASPxComboBox runat="server" ID="cmbTotTimeNoSup" Width="175px">
                                                                                                                        <ClientSideEvents SelectedIndexChanged="function(s,e){hasChanges(true,true);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                                                                                    </dx:ASPxComboBox>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                        ...
                                                                                        <TabTitle2>
                                                                                            <asp:Label ID="lblFilters" runat="server" Text="Filtros"></asp:Label>
                                                                                        </TabTitle2>
                                                                                        <TabContainer2>
                                                                                            <table style="margin: 5px;">
                                                                                                <tr>
                                                                                                    <td style="width: 320px;">
                                                                                                        <input type="checkbox" id="chkGSumRetInf" runat="server" onclick="hasChanges(true, true);" />&nbsp;<asp:Label ID="lblGSUmRetInf" runat="server" Text="Para sumas de retrasos inferiores a:"></asp:Label></td>
                                                                                                    <td style="width: 75px;">
                                                                                                        <dx:ASPxTimeEdit EditFormatString="HH:mm" EditFormat="Custom" ID="txtGSumRetHour" runat="server" Width="75px" ClientInstanceName="txtGSumRetHourClient">
                                                                                                            <ClientSideEvents DateChanged="function(s,e){hasChanges(true,true);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                                                                        </dx:ASPxTimeEdit>
                                                                                                    </td>
                                                                                                    <td style="width: 220px; text-align: right;">
                                                                                                        <dx:ASPxComboBox runat="server" ID="cmbGSumRetInf" Width="175px">
                                                                                                            <ClientSideEvents SelectedIndexChanged="function(s,e){hasChanges(true,true);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                                                                        </dx:ASPxComboBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 320px;">
                                                                                                        <input type="checkbox" id="chkGSumRetInt" runat="server" onclick="hasChanges(true, true);" />&nbsp;<asp:Label ID="lblGSUmRetInt" runat="server" Text="Para sumas de interrupciones inferiores a:"></asp:Label></td>
                                                                                                    <td style="width: 75px;">
                                                                                                        <dx:ASPxTimeEdit ID="txtGSumretInt" runat="server" Width="85px" EditFormatString="HH:mm" EditFormat="Custom" ClientInstanceName="txtGSumretIntClient">
                                                                                                            <ClientSideEvents DateChanged="function(s,e){hasChanges(true,true);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                                                                        </dx:ASPxTimeEdit>
                                                                                                    </td>
                                                                                                    <td style="width: 220px; text-align: right;">
                                                                                                        <dx:ASPxComboBox runat="server" ID="cmbGSumRetInt" Width="175px">
                                                                                                            <ClientSideEvents SelectedIndexChanged="function(s,e){hasChanges(true,true);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                                                                        </dx:ASPxComboBox>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="width: 320px;">
                                                                                                        <input type="checkbox" id="chkGSumAntInf" runat="server" onclick="hasChanges(true, true);" />&nbsp;<asp:Label ID="lblGSumAntInf" runat="server" Text="Para sumas de salidas anticipadas inferiores a:"></asp:Label></td>
                                                                                                    <td style="width: 75px;">
                                                                                                        <dx:ASPxTimeEdit ID="txtGSumAntInf" runat="server" Width="85px" EditFormatString="HH:mm" EditFormat="Custom" ClientInstanceName="txtGSumAntInfClient">
                                                                                                            <ClientSideEvents DateChanged="function(s,e){hasChanges(true,true);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                                                                        </dx:ASPxTimeEdit>
                                                                                                    </td>
                                                                                                    <td style="width: 220px; text-align: right;">
                                                                                                        <dx:ASPxComboBox runat="server" ID="cmbGSumAntInf" Width="175px">
                                                                                                            <ClientSideEvents SelectedIndexChanged="function(s,e){hasChanges(true,true);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                                                                        </dx:ASPxComboBox>
                                                                                                    </td>
                                                                                                </tr>
                                            ...
                                            <!-- Panell DailyRecord -->
                                            <div id="divDR" class="contentPanel" runat="server" name="menuPanel">
                                        ...
                                        <div id="div03" class="contentPanel" style="display: none" runat="server" name="menuPanel">
                                            <div class="panHeader2">
                                                <span style="">
                                                    <asp:Label runat="server" ID="lblZonesTitle" Text="Zonas horarias"></asp:Label></span>
                                            </div>
                                            <br />
                                            <div style="width: auto; padding: 20px; padding-top: 20px;">
                                                <table border="0" style="width: 100%;" height="50">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                <span class="spanEmp-Class">
                                                                    <asp:Label ID="lblZonesDesc" runat="server" Text="Desde aqui puede definir las distintas zonas horarias"></asp:Label>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <table style="margin-bottom: 0pt; margin-top: 0pt; margin-right: 0pt; width: 100%;" border="0" cellpadding="0" cellspacing="0">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="left">
                                                                                <div class="jsGrid" style="width: 974px">
                                                                                    <asp:Label ID="lblZonesGridTitle" runat="server" CssClass="jsGridTitle" Text="Zonas horarias"></asp:Label>
                                                                                ...
                                                                                <roUserControls:roTimeLine ID="tmZones" runat="server">
                                                                                    <Title>
                                                                                        <asp:Label ID="lblTMZones" runat="server" Text="Zonas horarias"></asp:Label>
                                                                                    </Title>
                                                                                </roUserControls:roTimeLine>
                                        ...
                                        <div id="div04" class="contentPanel" style="display: none" runat="server" name="menuPanel">
                                            <div class="panHeader2">
                                                <span style="">
    ...
    LostFocus="FadeOnLostFocus" />
                                        ...
                                        <!-- Panell avanzado -->
                                        <div id="div06" class="contentPanel" style="display: none" runat="server" name="menuPanel">
                                            <div class="panHeader2">
                                                <span style="">
                                        ...
                                        <!-- Panell Costes -->
                                        <div id="div07" class="contentPanel" style="display: none" runat="server" name="menuPanel">
                                            <div class="panHeader2">
                                                <span style="">
                                                    <asp:Label runat="server" ID="lblCostMainTitle" Text="Costes"></asp:Label></span>
                                            </div>
                                            <br />
                                            <div style="width: auto; padding: 20px; padding-top: 20px;">
                                                <table border="0" width="100%">
                                                    <tr>
                                                        <td width="48" height="48">
                                                            <img alt="" src="Images/BusinessCenters.png" />
                                                        </td>
                                                        <td align="left" valign="top">
                                                            <span id="span8" class="spanEmp-Class">
                                                                <asp:Label ID="lblCost" runat="server" Text="Indique el centro de coste del horario."></asp:Label></span>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="panBottomMargin">
                                                <div class="divRow">
                                                    <div class="divRowDescription">
                                                        <asp:Label ID="lblCostCenterDescription" ForeColor="#76859F" Font-Bold="true" runat="server" Text="Centro de coste que se asignará por defecto a todos los empleados que estén asignados al grupo."></asp:Label>
                                                    </div>
                                                    <div id="divCostDetail" runat="server">
                                                        <asp:Label ID="lblCostCenterTitle" runat="server" Text="Centro de coste:" CssClass="labelForm"></asp:Label>
                                                        <div class="componentForm">
                                                            ...
                                                            <tr>
                                                                <td colspan="2" valign="top" style="padding: 0px;">
                                                                    <table border="0" style="width: 100%; padding-top: 5px; padding-left: 5px;">
                                                                        <tr style="height: 40px;">
                                                                            <td>
                                                                                <asp:Label ID="lblCostConfig" runat="server" Text="Imputación de las horas al ${BusinessCenter} forzado"></asp:Label>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <table style="width: 100%;">
                                                                                    <tr>
                                                                                        <td style="padding-left: 5px;">
                                                                                            <roUserControls:roOptionPanelClient ID="opCostOnlyWork" runat="server" TypeOPanel="RadioOption" width="100%" height="Auto" Checked="False" Enabled="True" CConClick="hasChanges(true,true);">
                                                                                                <Title>
                                                                                                    <asp:Label ID="lblCostOnlyWorkTitle" runat="server" Text="Solo las horas trabajadas y extras"></asp:Label>
                                                                                                </Title>
                                                                                                <Description>
                                                                                                    <asp:Label ID="lblCostOnlyWorkDesc" runat="server" Text="Solo se imputaran las horas trabajadas y extras al centro forzado por el ${Shift}."></asp:Label>
                                                                                                </Description>
                                                                                                <Content>
                                                                                                </Content>
                                                                                            </roUserControls:roOptionPanelClient>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="padding-left: 5px; padding-top: 5px">
                                                                                            <roUserControls:roOptionPanelClient ID="opCostAll" runat="server" TypeOPanel="RadioOption" width="100%" height="Auto" Checked="False" Enabled="True" CConClick="hasChanges(true,true);">
                                                                                                <Title>
                                                                                                    <asp:Label ID="lblCostAllTitle" runat="server" Text="Todas las incidencias (horas trabajadas, extras, ausencias...)"></asp:Label>
                                                                                                </Title>
                                                                                                <Description>
                                                                                                    <asp:Label ID="lblCostAllDesc" runat="server" Text="Se imputaran todas las incidencias generadas al centro forzado por el ${Shift}."></asp:Label>
                                                                                                </Description>
                                                                                                <Content>
                                                                                                </Content>
                                                                                            </roUserControls:roOptionPanelClient>
                                        ...
                                        <!-- Panell Puestos -->
                                        <div id="div08" class="contentPanel" style="display: none" runat="server" name="menuPanel">
                                            <div class="panHeader2">
                                                <span style="">
                                                    <asp:Label runat="server" ID="lblAssignmentsMainTitle" Text="Puestos"></asp:Label></span>
                                            </div>
                                            <br />
                                            <div style="width: auto; padding: 20px; padding-top: 20px;">
                                                <table border="0" width="100%">
                                                    <tr>
                                                        <td width="48" height="48">
                                                            <img alt="" src="Images/Assignments.png" />
                                                        </td>
                                                        <td align="left" valign="top">
                                                            <span id="span7" class="spanEmp-Class">
                                                                <asp:Label ID="lblAssignments" runat="server" Text="Indique los puestos que puede cubrir el horario y su cobertura."></asp:Label></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2" align="center">
                                                            ...
                                                            <table width="100%">
                                                                <tr>
                                                                    <td valign="top" align="left">
                                                                        ...
                                                                        <input type="hidden" id="hdnLngAssignmentName" value="<%= Me.Language.Translate("gridHeader.AssignmentName",Me.DefaultScope) %>" />
                                                                        <input type="hidden" id="hdnLngCoverage" value="<%= Me.Language.Translate("gridHeader.Coverage",Me.DefaultScope) %>" />

                                                                        <!-- Grid JS -->
                                                                        <div class="jsGrid">
                                                                            <asp:Label ID="lblAssignmentGridTitle" runat="server" CssClass="jsGridTitle" Text="Puestos"></asp:Label>
                                                                            <div id="panTbAssignments" runat="server" class="jsgridButton">
                                                                                <div class="btnFlat">
                                                                                    <a href="javascript: void(0)" id="btnAddAssignments" runat="server" onclick="AddNewAssignments();">
                                                                                        <span class="btnIconAdd"></span>
                                                                                        <asp:Label ID="lblAddAssignments" runat="server" Text="Añadir puesto"></asp:Label>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div id="grdAssignments" class="jsGridContent" runat="server">
                                                                            <!-- Aqui va el grid de Puestos-->
                                                                        </div>
                                                                        <!-- popup TabContainerPuestos -->
                                                                        <roForms:frmAddAssignment ID="frmAddAssignment1" runat="server" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                        ...
                                        <!-- Panell Propiedades -->
                                        <div id="div09" class="contentPanel" style="display: none" runat="server" name="menuPanel">
                                            <div class="panHeader2">
                                                <span style="">
                                                    <asp:Label runat="server" ID="lblPropsTitle" Text="Propiedades"></asp:Label></span>
                                            </div>
                                            <br />
                                            <div style="width: auto; padding: 15px;">
                                                <table border="0" style="width: 100%;" height="50">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top" width="100%">
                                                                <span id="span2" class="spanEmp-Class" style="width: 100%;">
                                                                    <asp:Label ID="lbPropsDesc" runat="server" Text="Desde aquí podrá definir las propiedades internas del ${Shift}." Width="100%"></asp:Label><br />
                                                                    <asp:Label ID="lblPropsDesc2" Visible="False" runat="server" Text="Puede determinar si este ${Shift} se utilizará para determinadas operaciones como solicitar cambio de ${Shift} o permisos (ej: permiso para examen)."></asp:Label>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" align="center" style="padding-top: 5px; padding-left: 25px; padding-right: 25px; width: 100%;">
                                                                <div style="display: none;">
                                                                    <roUserControls:roOptionPanelClient ID="optChkShowShift" runat="server" TypeOPanel="CheckboxOption" width="100%" height="Auto" Checked="False" Enabled="True" style="width: 100%;" CConClick="hasChanges(true,false);">
                                                                        <Title>
                                                                            <asp:Label ID="lblChkShowShift" runat="server" Text="Mostrar el ${Shift} al realizar solicitudes"></asp:Label>
                                                                        </Title>
                                                                        ...
                                                                        <Content>
                                                                            <table style="width: 100%; padding-top: 10px;" border="0" width="100%">
                                                                                <tr>
                                                                                    <td style="padding-left: 25px; padding-top: 15px; padding-right: 25px; width: 100%;">
                                                                                        <roUserControls:roOptionPanelClient ID="optShiftChange" runat="server" TypeOPanel="RadioOption" width="100%" height="Auto" Checked="False" Enabled="True" Border="True" CConClick="hasChanges(true,false);">
                                                                                            <Title>
                                                                                                <asp:Label ID="lblShiftChange" runat="server" Text="Tipo cambio de ${Shift}."></asp:Label>
                                                                                            </Title>
                                                                                            <Description>
                                                                                                <asp:Label ID="lblShiftChangeDesc" runat="server" Text="Este ${Shift} se utilizará en el módulo de solicitud de permisos."></asp:Label>
                                                                                            </Description>
                                                                                            <Content>
                                                                                            </Content>
                                                                                        </roUserControls:roOptionPanelClient>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="padding-left: 25px; padding-right: 25px; width: 100%;">
                                                                                        <roUserControls:roOptionPanelClient ID="optTypePerms" runat="server" TypeOPanel="RadioOption" width="100%" height="Auto" Checked="False" Enabled="True" Border="True" CConClick="hasChanges(true,false);">
                                                                                            <Title>
                                                                                                <asp:Label ID="lblTypePerms" runat="server" Text="Tipo permisos"></asp:Label>
                                                                                            </Title>
                                                                                            <Description>
                                                                                                <asp:Label ID="lblTypePermsDesc" runat="server" Text="Este ${Shift} se utilizará en el módulo de solicitud de permisos."></asp:Label>
                                                                                            </Description>
                                                                                            <Content>
                                                                                                <table style="width: 100%; margin-left: 25px;" border="0">
                                                                                                    <tr>
                                                                                                        <td style="padding-top: 5px;">
                                                                                                            <asp:Label ID="lblConsiderDaysPlan" runat="server" Text="Los días planificados con este ${Shift} se consideran:"></asp:Label></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding-left: 10px; padding-top: 5px;">
                                                                                                            <input type="radio" id="radioWorkingDays" name="radioGroup" />&nbsp;<a href="javascript: void(0);" onclick="document.getElementById('radioWorkingDays').checked=true; hasChanges(true,false);"><asp:Label ID="lblWorkingDays" runat="server" Font-Bold="true" Text="Días laborables"></asp:Label></a><br />
                                                                                                            <input type="radio" id="radioNaturalDays" name="radioGroup" />&nbsp;<a href="javascript: void(0);" onclick="document.getElementById('radioNaturalDays').checked=true; hasChanges(true,false);"><asp:Label ID="lblNaturalDays" runat="server" Font-Bold="true" Text="Días naturales"></asp:Label></a>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding-top: 5px;">
                                                                                                            <asp:Label ID="lblConceptDisp" runat="server" Text="Indique el acumulado utilizado como saldo disponible para el permiso solicitado."></asp:Label></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td style="padding-left: 10px;">
                                                                                                            <dx:ASPxComboBox runat="server" ID="cmbSoldDisp" Width="200px">
                                                                                                                <ClientSideEvents SelectedIndexChanged="function(s,e){hasChanges(true,false);}" GotFocus="HightlightOnGotFocus" LostFocus="FadeOnLostFocus" />
                                                                                                            </dx:ASPxComboBox>
                                                                                                        </td>
                                                                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" style="padding-top: 15px; padding-left: 55px; padding-right: 25px; width: 100%;">
                                                                <asp:Label ID="lblObsoleteCheck" runat="server" Font-Bold="true" Text="Si no quiere que este ${Shift} pueda ser asignado a ningún empleado, marque la casilla de verificación."></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="padding-top: 5px; padding-left: 85px; padding-right: 25px; width: 100%;"></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="padding-top: 15px; padding-left: 55px; padding-right: 25px; width: 100%;">
                                                                <asp:Label ID="lblSchemaCheck" runat="server" Font-Bold="true" Text="Si quiere utilizar este ${Shift} como una plantilla para crear ${Shifts} nuevos, marque la siguiente casilla de verificación." Style="display: none;"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="2" style="padding-top: 5px; padding-left: 85px; padding-right: 25px; width: 100%;">
                                                                <input type="checkbox" runat="server" id="chkSchema" style="display: none;" />&nbsp;<a href="javascript: void(0);" onclick="document.getElementById('chkSchema').checked=!document.getElementById('chkSchema').checked;hasChanges(true,false);" style="display: none;"><asp:Label ID="lblCSchema" runat="server" Font-Bold="true" Text="Este ${Shift} es una plantilla"></asp:Label></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
