...
function frmNewTypeZone_AjaxSave() {
    try {
        ...
        AsyncCall("POST", "Handlers/srvShifts.ashx?action=updateTypeZone&" + oFields, "json", "arrStatus", "checkShiftStatus(arrStatus); if(arrStatus[0].error == 'false'){ hasChanges(true); frmNewTypeZone_Close(); }");
...
function frmNewTypeZone_AjaxLoad(oId) {
    try {
        ...
        AsyncCall("POST", "Handlers/srvShifts.ashx?action=loadTypeZone&" + oFields, "json", "arrFields", "frmNewTypeZone_loadValues(arrFields);");
...
function frmNewTypeZone_AjaxDelete(oId) {
    try {
        ...
        AsyncCall("POST", "Handlers/srvShifts.ashx?action=deleteTypeZone&" + oFields, "json", "arrFields", "frmNewTypeZone_Close();");
...
function frmNewTypeZone_reloadCombo() {
    try {
        AsyncCall("POST", "Handlers/srvShifts.ashx?action=reloadTypeZones", "json", "arrFields", "frmNewTypeZone_loadCombo(arrFields);");
