<%@ Page Language="VB" AutoEventWireup="false" Inherits="VTLive40.Base_CreateObjectPopup" CodeBehind="CreateObjectPopup.aspx.vb" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function CloseClick() {
            window.parent.NewObjectPopup_Client.SetContentUrl('');
            window.parent.NewObjectPopup_Client.Hide();
        }
        function AcceptClick() {
            if (newObjectName_Client.GetValue() != null && newObjectName_Client.GetValue() != "") {
                window.parent.NewObjectCallback(newObjectName_Client.GetValue());
                window.parent.NewObjectPopup_Client.SetContentUrl('');
                window.parent.NewObjectPopup_Client.Hide();
            } else {
                    ...
                    <div class="bodyPopupExtended" style="table-layout: fixed; height: 185px; width: 375px;">
                            ...
                            <tr>
                                ...
                                <td style="padding-bottom: 10px;" height="20px" valign="top">
                                    <div class="panHeader2">
                                        <span style="">
                                            <asp:Label ID="lblTitle" runat="server" Text="Nuevo objecto"></asp:Label>
                                        </span>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td align="left" valign="middle">
                                                <asp:Label ID="lblDescription1" runat="server" CssClass="editTextFormat" Text="Introduzca el nombre del nuevo objecto"></asp:Label>
                                                <br />
                                                <asp:Label ID="lblDescription2" runat="server" CssClass="editTextFormat" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table style="margin-left: auto;">
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxButton ID="btnCancel" ClientInstanceName="btnCancelClient" runat="server" AutoPostBack="False" CausesValidation="False" Text="${Button.Accept}" ToolTip="${Button.Accept}"
                                        HoverStyle-CssClass="btnFlat-hover btnFlatBlack-hover" CssClass="btnFlat btnFlatBlack">
