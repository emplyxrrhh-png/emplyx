<%@ Page Language="VB" AutoEventWireup="false" Inherits="VTLive40.Base_PerformingAction" CodeBehind="PerformingAction.aspx.vb" %>
        ...
        <dx:ASPxPanel ID="panelUploadContent" runat="server" Width="0px" Height="0px">
            <PanelCollection>
                <dx:PanelContent ID="PopupUploadPanelContent" runat="server">
                    <div class="bodyPopupExtended" style="table-layout: fixed; height: 100px; left: 4px; width: 430px; position: relative; top: 10px;">
                        <table cellpadding="0" cellspacing="0" width="100%" height="100%" class="bodyPopup">
                            ...
                            <tr>
                                <td colspan="2" style="padding-top: 5px; padding-left: 10px" align="center">
                                    <asp:Label ID="lblupExecuteInfo" Text="Esta operación puede tardar unos minutos dependiendo del volumen de información" ForeColor="blue" runat="server" />
                                </td>
                            </tr>
                            <tr>
