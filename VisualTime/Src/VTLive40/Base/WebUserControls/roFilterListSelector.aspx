<%@ Page Language="VB" AutoEventWireup="false" Inherits="VTLive40.Base_WebUserControls_roFilterListSelector" CodeBehind="roFilterListSelector.aspx.vb" %>
                    ...
                    <td>
                        <div id="divFilterList" class="frameFilterList">
                            <div style="height: 50px;">
                                ...
                                <span style="display: block; width: 200px; padding-left: 3px; padding-top: 4px; padding-bottom: 2px;" class="editTextFormat">
                                    <asp:Label ID="lblFindText" runat="server" Text="Buscar por:"></asp:Label>
                                </span>

                                <input type="text" id="FieldFindValue" class="textClass" style="text-align: left; border-color: #D7D7D7; height: 20px; margin-left: 1px; margin-top: 2px; margin-bottom: 2px; width: 98%;"
    ...
    <script language="javascript" type="text/javascript">
        ...
        function PageBase_Unload() {
            ...
            if (hdnSelectedValue != "-1") {
                try {
                    parent.TaskChange(hdnSelectedValue, hdnSelectedName);
                } catch (e) { }
            }
        }
        ...
        function EnProgreso(Modo) {
            ...
            if (Modo == true) $Progreso.appendTo(divFilterList).show();
            else $Progreso.hide();
        }
        ...
        function newItemInGrid(KeyToFiter) {
            try {
                ...
                var path = '<%= Me.Page.ResolveURL("~/Base/WebUserControls/roFilterListSelectorsrv.aspx")%>' + "?action=newItemInGrid";
                if (KeyToFiter != null) {
