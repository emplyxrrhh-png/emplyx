<%@ Control Language="VB" AutoEventWireup="false" Inherits="VTLive40.Base_WebUserControls_MessageModalV2" CodeBehind="MessageModalV2.ascx.vb" %>

<script language="javascript" type="text/javascript">

    function HideMessage() {
        if ($get('<%= hdnCloseClient.ClientID %>').value == '1')
            hidePopup('MessageModalPopupFormBehavior');
    }
...
<asp:UpdatePanel ID="updMessageFrame" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <ajaxToolkit:ModalPopupExtender ID="MyModalPopupExtender" runat="server" DropShadow="false" TargetControlID="MyHideButton"
            PopupControlID="MyPopupFrame_DIV" BehaviorID="MessageModalPopupFormBehavior">
