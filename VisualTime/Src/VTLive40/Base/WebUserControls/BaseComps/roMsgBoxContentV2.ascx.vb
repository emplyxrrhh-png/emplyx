Partial Class Base_WebUserControls_roMsgBoxContentV2
    Inherits System.Web.UI.UserControl

#Region "Properties"

    Public Property BodyPopupClass As String
        Get
            Return Me.popupBody.Attributes("class")
        End Get
        Set(value As String)
            Me.popupBody.Attributes("class") = value
        End Set
    End Property
