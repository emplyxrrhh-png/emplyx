...
}(function ($, moment)
{
	...
	$.dateRangePickerLanguages =
	{
		...
		'ca':
		{
		    ...
		    'week-6': 'sa',
		    'week-7': 'do',
		    'month-name': ['gener', 'febrer', 'març', 'abril', 'maig', 'juny', 'juliol', 'agost', 'setembre', 'octubre', 'noviembre', 'desembre'],
		    ...
		    'next-month': 'Mes',
		    'next-year': 'Any',
		    'less-than': 'El rang no hauria de ser major de %d dies',
		    'more-than': 'El rang no hauria de ser menor de %d dies',
		    'default-more': 'Si us plau selecciona un rang major a %d dies',
		    'default-single': 'Si us plau seleccioneu un dia',
		    'default-less': 'Si us plau selecciona un rang menor a %d dies',
		    'default-range': 'Si us plau selecciona un rang entre %d i %d dies',
		    'default-default': 'Si us plau selecciona un rang de dates.',
		    'separator': ' fins ',
		    'format': 'DD-MM-YYYY'
		}, 
		...
		'pt':
		{
			...
			'default-more': 'Por favor selecione um intervalo maior que %d dias',
			'default-single': 'Por favor selecione uma data',
			'default-less': 'Por favor selecione um intervalo menor que %d dias',
			'default-range': 'Por favor selecione um intervalo entre %d e %d dias',
			'default-default': 'Por favor selecione uma data',
			'separator': ' até '
		},
		'gl':
		{
			...
			'default-more': 'Por favor escolle un intervalo maior de %d días',
			'default-single': 'Por favor escolle unha data',
			'default-less': 'Por favor escolle un intervalo menor de %d días',
			'default-range': 'Por favor escolle un intervalo entre %d e %d días',
			'default-default': 'Por favor escolle unha data',
			'separator': ' ata '
		},
		'eu':
		{
			...
			'past': 'Iragana',
			'following': 'Etorkizuna',
			'previous': 'Aurrekoa',
			'prev-week': 'Astea',
			'prev-month': 'Hilabetea',
			'prev-year': 'Urtea',
			'next': 'Hurrengoa',
			'next-week': 'Astea',
			'next-month': 'Hilabetea',
			'next-year': 'Urtea',
			'less-than': 'Tartea ez da %d egun baino handiagoa izan behar',
			'more-than': 'Tartea ez da %d egun baino txikiagoa izan behar',
			'default-more': 'Mesedez, hautatu %d egun baino handiagoa den tarte bat',
			'default-single': 'Mesedez, hautatu data bat',
			'default-less': 'Mesedez, hautatu %d egun baino txikiagoa den tarte bat',
			'default-range': 'Mesedez, hautatu %d eta %d egun arteko tarte bat',
			'default-default': 'Mesedez, hautatu data bat',
			'separator': ' - '
		},
		'hu':
		{
	...
	$.fn.dateRangePicker = function(opt)
	{
		...
		opt.separator = lang('separator');
		//opt.format = lang('format');
		var box;
		var initiated = false;
		var self = this;
		...
		function dayClicked(day)
		{
			...
			else if (opt.batchMode === 'twoWeek') {
			    if (opt.startOfWeek === 'monday') {
			        opt.start = moment(parseInt(time)).startOf('isoweek').valueOf();
			        opt.end = moment(parseInt(time)).add(1, 'week').endOf('isoweek').valueOf();
			    } else {
			        opt.end = moment(parseInt(time)).add(1, 'week').endOf('week').valueOf();
			        opt.start = moment(parseInt(time)).startOf('week').valueOf();
			    }
			}
