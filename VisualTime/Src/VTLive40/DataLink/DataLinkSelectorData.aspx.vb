...
Partial Class DataLinkSelectorData
...
#Region "Declarations"
    ...
    Private strIconDatalink As String = "Datalink_16.png"
    Private strIconDatalinkCustom As String = "DatalinkCustom_16.png"
...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Me.strImagesPath = "../../images/DatalinkSelector"
        End If
        ...
        If Session("DatalinkSelector_Selection") IsNot Nothing Then
            Dim strSelection As String = Session("DatalinkSelector_Selection")
...
#Region "Methods"
    ...
    Private Sub LoadDatalinkTree()

        Dim oGuides As List(Of roDatalinkGuide) = API.DataLinkGuideServiceMethods.GetDatalinkGuides(Me.Page, False)
        oGuides = oGuides.OrderBy(Function(x) x.IsCustom).ThenBy(Function(x) x.Name).ToList

        If oGuides.Count > 0 Then
            For Each oGuide In oGuides
                'If "A" & dRow("IDParent") = strIDParent Then
                strArrayNodes &= "{ 'id':'" & oGuide.Concept.ToString & "', 'text':'" & oGuide.Name & "', " &
                                 "'leaf': true, " &
                                 "'icon': '" & Me.strImagesPath & IIf(Not oGuide.IsCustom, strIconDatalink, strIconDatalinkCustom) & "'"
                strArrayNodes &= "},"
                'End If
            Next
        End If
