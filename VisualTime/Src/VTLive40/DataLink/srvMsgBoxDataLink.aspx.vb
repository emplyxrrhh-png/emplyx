...
Partial Class srvMsgBoxDataLink
    Inherits PageBase
...
#Region "Events"
    ...
    Protected Sub Page_Load1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.HasFeaturePermission("Employees", Permission.Admin) Or
           Me.HasFeaturePermission("Calendar.Scheduler", Permission.Write) Then
        Else
