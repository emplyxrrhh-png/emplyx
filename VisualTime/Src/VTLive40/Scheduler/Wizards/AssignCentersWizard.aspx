<%@ Page Language="VB" AutoEventWireup="false" Inherits="VTLive40.Forms_AssignCentersWizard" Culture="auto" UICulture="auto" EnableEventValidation="false" CodeBehind="AssignCentersWizard.aspx.vb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html lang="en" class="notranslate" translate="no" xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Asistente para asignacion masiva de centros de coste</title>
</head>
        ...
        <div>
            ...
            <script language="javascript" type="text/javascript">
                ...
                async function PageBase_Load() {
                    if (!bolLoaded) {
                        await getroTreeState('objContainerTreeV3_treeEmpAssignCentersWizard').then(roState => roState.reset());
                        await getroTreeState('objContainerTreeV3_treeEmpAssignCentersWizardGrid').then(roState => roState.reset());
                    }
                    var oActiveFrameIndex = document.getElementById('<%= hdnActiveFrame.ClientID %>').value;
                    ConvertControls('divStep' + oActiveFrameIndrue);
            ...
            <asp:UpdatePanel ID="upAssignCentersWizard" runat="server">
                <ContentTemplate>
                    <div class="popupWizardContent">
                            ...
                            <table id="tbStep0" style="width: 100%; height: 100%;" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="height: 360px">
                                        <asp:Image ID="imgAssignCentersWizard" runat="server" Style="border-radius: 5px;" ImageUrl="~/Base/Images/Wizards/wztemplate.gif" />
                                    </td>
                                    <td style="padding-left: 20px; padding-right: 20px; padding-top: 50px" valign="top">

                                        <asp:Label ID="lblCopyScheduleWelcome1" runat="server" Text="Bienvenido al asistente para la asignación masiva de centros de coste."
                                            Font-Bold="True" Font-Size="Large"></asp:Label>
                                        <br />
                                        <br />
                                        <br />
                                        <asp:Label ID="lblCopyScheduleWelcome2" runat="server" Text="El asistente le permite asignar de forma masiva los centros de coste a las justificaciones diarias de empleados en un periodo determinado." Font-Bold="true"></asp:Label>
                                        <br />
                                        <br />
                        ...
                        <asp:Label ID="hdnStepTitle" Text="Asistente para la asignación masiva de centros de coste." runat="server" Style="display: none; visibility: hidden" />
                            ...
                            <table id="btStep2" style="width: 100%;" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td class="SchedulerWizards_StepContent">
                                        <asp:Label ID="lblStep2Info2" runat="server" Text="Ahora seleccione los empleados a los que quiere asignar los centros de coste. " /><br />
                                        <br />
                                            ...
                                            <tr>
                                                <td class="LaunchTaskTemplateWizard_StepContent" valign="top" style="padding-top: 10px;">
                                                    <div style="height: 375px; overflow: auto">
                                                        <dx:ASPxGridView ID="grdCauses" runat="server" Cursor="pointer" AutoGenerateColumns="False" ClientInstanceName="grdCausesClient" KeyboardSupport="True" Width="100%" Settings-ShowTitlePanel="True">
                                ...
                                <tr>
                                    <td class="AssignScheduleTemplateWizards_StepTitle2">
                                        <table style="width: 100%">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblStep5Title" runat="server" Text="Paso 4 de 5." Font-Bold="True" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-left: 20px; padding-right: 40px">
                                                    <asp:Label ID="lblStep5Info" runat="server" Text="Finalmente, asigne el centro de coste a las justificaciones seleccionadas. " />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                            ...
                                            <tr>
                                                <td class="LaunchTaskTemplateWizard_StepContent" valign="top" style="padding-top: 10px;">
                                                    <div style="height: 325px; overflow: auto">
                                                        <dx:ASPxGridView ID="GridIncidences" runat="server" Cursor="pointer" AutoGenerateColumns="False" ClientInstanceName="GridTasksClient" KeyboardSupport="True" Width="100%" ClientSideEvents-BeginCallback="GridIncidences_beginCallback" Settings-ShowTitlePanel="True">
                                                            <SettingsBehavior AllowFocusedRow="True" AllowSelectSingleRowOnly="false" AllowSort="False" />
                                                            <Styles>
                                                                <Cell Wrap="False"></Cell>
                                                                <TitlePanel CssClass="TitlePanelClass"></TitlePanel>
                                                            ...
                                                            <Settings VerticalScrollBarMode="Auto" UseFixedTableLayout="True" VerticalScrollableHeight="288" />
                                                        </dx:ASPxGridView>
                                                    ...
                                                    <div style="clear: both">
                                                        ...
                                                        <div style="float: left">
                                                            <dx:ASPxComboBox ID="cmbCostCenters" runat="server" ClientInstanceName="cmbCostCentersClient" Width="250px"></dx:ASPxComboBox>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                    ...
                    <div class="popupWizardButtons">
                        <table align="right" cellpadding="0" cellspacing="0">
                            <tr class="SchedulerWizards_ButtonsPanel" style="height: 44px">
                                ...
                                <td>
                                    <asp:Button ID="btClose" Text="${Button.Cancel}" runat="server" OnClientClick="Close(); return false;" TabIndex="4" CssClass="btnFlat btnFlatBlack btnFlatAsp" />
