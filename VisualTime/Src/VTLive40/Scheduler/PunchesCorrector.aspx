<%@ Page Language="VB" AutoEventWireup="false" Inherits="VTLive40.PunchesCorrector" EnableEventValidation="false" EnableViewState="True" CodeBehind="PunchesCorrector.aspx.vb" %>
        ...
        <div>
            ...
            <script type="text/javascript">
                ...
                function GridEntries_EndCallback(s, e) {
                    ...
                    if (s.cpActionReprocess != undefined && s.cpActionReprocess == "RepOk") {
                        Robotics.Client.JSErrors.showJSerrorPopup(Robotics.Client.JSErrors.JSErrorTypes.roJsSuccess, '',
                            { text: '', key: 'roJsSuccess' }, { text: '', key: 'roProcessOk' },
                            { text: '', textkey: 'roErrorClose', desc: '', desckey: '', script: 'GridEntriesClient.PerformCallback("RELOAD");' },
                    ...
                    else if (s.cpActionReprocess != undefined && s.cpActionReprocess == "RepKo") {
                        Robotics.Client.JSErrors.showJSerrorPopup(Robotics.Client.JSErrors.JSErrorTypes.roJsError, '',
                            { text: '', key: 'roJsError' }, { text: '', key: 'roProcessKo' },
                ...
                function Reprocess() {
                    ...
                    GridEntriesClient.PerformCallback("REPROCESS");
            ...
            <table cellpadding="2" cellspacing="2" width="100%" style="padding: 5px 5px 5px 5px;">
                <tr valign="middle">
                    <td colspan="2" style="padding-top: 5px; padding-bottom: 0px;" valign="top" height="20px">
                        <div class="panHeader2">
                            <span style="">
                                <asp:Label ID="lblTitle" runat="server" Text="Fichajes no importados"></asp:Label></span>
                        </div>
                    </td>
                </tr>
                <tr style="height: 48px;">
                    ...
                    <td align="left" valign="middle" style="padding: 4px; padding-bottom: 10px;">
                        <asp:Label ID="lblDescription" runat="server" CssClass="editTextFormat" Text="Este formulario le permite ver los fichajes y el motivo por el qual no se han importado en VisualTime."></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <dx:ASPxGridView ID="GridEntries" runat="server" AutoGenerateColumns="False" ClientInstanceName="GridEntriesClient" KeyboardSupport="True" Width="100%">
                            ...
                            <Settings VerticalScrollBarMode="Auto" UseFixedTableLayout="False" VerticalScrollableHeight="280" />
                        </dx:ASPxGridView>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    Text="Seleccionar todos" runat="server" Cursor="pointer" ClientSideEvents-Click="OnSelectAllRowsLinkClick" />--%>
                                    <%-- <asp:Button ID="btOK" Text="Seleccionar todos" runat="server"   OnClientClick="OnSelectAllRowsLinkClick();" CssClass="btnFlat btnFlatBlack btnFlatAsp" />--%>
                                    <%--OnClientClick="OnSelectAllRowsLinkClick();"--%>
                                    <asp:Button ID="btReprocess" Text="Reprocesar" runat="server" OnClientClick="Reprocess(); return false;" CssClass="btnFlat btnFlatBlack btnFlatAsp" />
                                </td>
                                <td align="right">
                                    <asp:Button ID="btCancel" Text="${Button.Close}" runat="server" OnClientClick="Close(); return false;" CssClass="btnFlat btnFlatBlack btnFlatAsp" />
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <asp:Label ID="lblCardAssignWizardFormTitle" Text="Asistente para detectar fichajes inválidos en VisualTime" Style="display: none" runat="server" />
