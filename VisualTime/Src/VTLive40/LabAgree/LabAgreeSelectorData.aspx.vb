...
Partial Class LabAgreeSelectorData
...
#Region "Declarations"
    ...
    Private strIconLabAgree As String = "LabAgree_16.png"
    ...
    Private bolFilterLabAgree As Boolean = True
...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Filters <> "" Then
            If Filters.Substring(0, 1) = "1" Then Me.bolFilterLabAgree = True Else Me.bolFilterLabAgree = False
        End If

        If Session("LabAgreeSelector_Selection") IsNot Nothing Then
            Dim strSelection As String = Session("LabAgreeSelector_Selection")
        ...
        If dTbl.Rows.Count > 0 Then
            For Each dRow As DataRow In dTbl.Rows
                ...
                strArrayNodes &= "{ 'id':'" & dRow("ID") & "', 'text':'" & dRow("Name").Replace("'", "&#39;") & "', " &
                                 "'leaf': true, " &
                                 "'icon': '" & Me.strImagesPath & strIconLabAgree & "'"
                strArrayNodes &= "},"
                'End If
            Next
        End If
