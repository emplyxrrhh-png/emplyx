...
<head>
    ...
    <script type="text/javascript" src="@Url.Content("~/Base/globalize/sugar.min.js")@Html.Raw(scriptVersion)"></script>
    ...
    <script src="@Url.Content("~/Base/Scripts/Live/Common/historicGrid.min.js")@Html.Raw(scriptVersion)" type="text/javascript"></script>
