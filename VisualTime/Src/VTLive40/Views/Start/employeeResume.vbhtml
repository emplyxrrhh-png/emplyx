...
<div class="panHeaderDashboardSmall">
    @StartController.GetServerLanguage().Translate("roMyTeam", "Start")
</div>

<div class="list-containerRequests">

    @(Html.DevExtreme().List() _
                                                                                                                                                                        .ID("listResumeEmployees") _
                                                                                                                                                                                    .Height("100%") _
                                                                                                                                                                                    .DataSource(Function(ds)
                                                                                                                                                                                                    Return ds.Mvc() _
                                                                                                                                                                                                         .Controller("Start") _
                                     .Key("ImageSrc") _
                                                                                                                                                                                                         .LoadAction("GetEmployeeResume")
                                                                                                                                                                                                End Function) _
                                    ...
                                    .SelectionMode(ListSelectionMode.Single) _
                                                                                                                                                                                    ...
                                                                                                                                                                                    .ActiveStateEnabled(False) _
                                                                                                                                                                                    .OnSelectionChanged("filterGridStatus") _
                                                .OnItemClick("restoreFiltersStatus") _
