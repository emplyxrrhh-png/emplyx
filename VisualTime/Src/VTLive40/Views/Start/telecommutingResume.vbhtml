...
<div class="panHeaderDashboardSmall">
    @StartController.GetServerLanguage().Translate("roMyTeamTC", "Start")
</div>

<div class="list-containerRequests">

    @(Html.DevExtreme().List() _
                                                                                                                                    .ID("listResumeEmployeesTC") _
                                                                                                                                    .Height("100%") _
                                                                                                                                    .DataSource(Function(ds)
                                                                                                                                                    Return ds.Mvc() _
                                                                                                                                             .Controller("Start") _
                        .Key("ImageSrc") _
                                                                                                                                                    .LoadAction("GetTelecommutingResume")
                                                                                                                                                End Function) _
                                                                                                            ...
                                                                                                            .SelectionMode(ListSelectionMode.Single) _
                                                                                                                                                            ...
                                                                                                                                                            .OnSelectionChanged("filterGridTelecommute") _
                        .OnItemClick("restoreFiltersTelecommute") _
