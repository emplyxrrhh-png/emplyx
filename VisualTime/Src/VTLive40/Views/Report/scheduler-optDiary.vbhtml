...
<span class="schedulerTxt" style="text-transform:capitalize">@ReportController.GetServerLanguage().Translate("roReportSchedulerEvery", "ReportsDX") </span><span class="opt1" style="width: 80px"></span><span class="schedulerTxt"> @ReportController.GetServerLanguage().Translate("roReportSchedulerDays", "ReportsDX"), </span><span class="schedulerTxt"> @ReportController.GetServerLanguage().Translate("roReportSchedulerAt", "ReportsDX") </span><span class="opt2" style="width: 135px"></span>