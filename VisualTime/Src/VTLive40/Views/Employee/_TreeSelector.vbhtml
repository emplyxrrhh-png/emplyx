...
@Code
    ...
    Else
        ...
        End If
    End If
    Dim customFilterEnabled As Boolean = ViewBag.advancedFilterEnabled
End Code
...
<div style="height:470px;width:650px;" id="editView">
    <form id="selectorEmployees"
        ...
        <iframe id="ifEmployeesSelector" name="advSelectorContainer"
                ...
                src="~/Base/WebUserControls/roWizardSelectorContainerMultiSelectV3.aspx?PrefixTree=mvcTreeSelector&FeatureAlias=@Html.Raw(Employees)&PrefixCookie=objContainerTreeV3_mvcTreeSelectorGrid&AfterSelectFuncion=parent.employeeMVCSelector_collectParamValues&EnableCustomFilters=@Html.Raw(customFilterEnabled.ToString().ToLower())">
        </iframe>
    </form>
</div>