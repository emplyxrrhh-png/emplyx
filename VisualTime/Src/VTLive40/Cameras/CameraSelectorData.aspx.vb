...
Partial Class CamerasSelectorData
...
#Region "Declarations"
    ...
    Private strIconCameras As String = "Camera_16.png"
    ...
    Private bolFilterCameras As Boolean = True
...
#Region "Events"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            Me.strImagesPath = "../../images/CamerasSelector"
        End If
        ...
        If Filters <> "" Then
            If Filters.Substring(0, 1) = "1" Then Me.bolFilterCameras = True Else Me.bolFilterCameras = False
        End If

        If Session("CamerasSelector_Selection") IsNot Nothing Then
            Dim strSelection As String = Session("CamerasSelector_Selection")
...
#Region "Methods"
    ...
    Private Sub LoadCamerasTree()

        Dim dTbl As DataTable = API.CameraServiceMethods.GetCameras(Me.Page)
        ...
        If dTbl.Rows.Count > 0 Then
            For Each dRow As DataRow In dTbl.Rows
                ...
                strArrayNodes &= "{ 'id':'" & dRow("ID") & "', 'text':'" & dRow("Name").Replace("'", "&#39;") & "', " &
                                 "'leaf': true, " &
                                 "'icon': '" & Me.strImagesPath & strIconCameras & "'"
                strArrayNodes &= "},"
                'End If
            Next
        End If
