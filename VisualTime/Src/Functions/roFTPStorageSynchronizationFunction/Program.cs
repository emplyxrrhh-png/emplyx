...
namespace roFTPStorageSynchronizationFunction
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Robotics.DataLayer.AccessHelper.InitializeSharedInstanceData(roAppType.roFTPSyncFunction, roLiveQueueTypes.pnlink);
