...
Public Class EnvironmentHelper
    ...
    Public Property OnActionExecuted As Boolean = False
    Public Property OnAccessDenied As Boolean = False

    Public Sub New()

    End Sub

    Public Sub InitializeEnvirontment(Optional dSessionParameters As Dictionary(Of String, String) = Nothing, Optional requestHeaders As Dictionary(Of String, String) = Nothing, Optional requestCookies As Dictionary(Of String, String) = Nothing, Optional requestParams As Dictionary(Of String, String) = Nothing, Optional requestUserHostAddress As String = "8.8.8.8", Optional requestUrl As String = "http://localhost:8080")

        System.Web.Mvc.Fakes.ShimRedirectResult.ConstructorString = Sub(instance, url)
                                                                        OnAccessDenied = True
                                                                    End Sub

        System.Web.Mvc.Fakes.ShimActionFilterAttribute.AllInstances.OnActionExecutingActionExecutingContext = Sub(instance, filterContext)
        ...
        System.Web.Fakes.ShimHttpContext.CurrentGet = Function()
                                                          ...
                                                          context.RequestGet = Function()
                                                                                   ...
                                                                                   instance.ParamsGet = Function()
                                                                                                            ...
                                                                                                            Return nameValueCollection
                                                                                                        End Function
                                                                                   instance.CookiesGet = Function()
                                                                                                             Dim nameValueCollection As New HttpCookieCollection()
                                                                                                             If requestParams Is Nothing Then Return nameValueCollection
                                                                                                             For Each kvp As KeyValuePair(Of String, String) In requestCookies
                                                                                                                 nameValueCollection.Add(New HttpCookie(kvp.Key, kvp.Value))
                                                                                                             Next
                                                                                                             Return nameValueCollection
                                                                                                         End Function
