...
<DataContract>
Public Class wscGuiState
    Inherits Robotics.VTBase.Extensions.roState

#Region "Declarations / Constructor"

    Private intResult As GuiStateResultEnum

    Public Sub New()
        MyBase.New(-1, "VTBusiness.Portal")
        Me.intResult = GuiStateResultEnum.NoError
    End Sub

    Public Sub New(ByVal _IDPassport As Integer)
        MyBase.New(_IDPassport, "VTBusiness.Portal")
        Me.intResult = GuiStateResultEnum.NoError
    End Sub
...
#Region "Properties"
    ...
    <IgnoreDataMember>
    Public Property Result() As GuiStateResultEnum
        Get
            Return Me.intResult
        End Get
        Set(ByVal value As GuiStateResultEnum)
            Me.intResult = value
            If Me.intResult <> GuiStateResultEnum.NoError AndAlso Me.intResult <> GuiStateResultEnum.Exception Then
    ...
    Public Overrides Sub LoadLanguage()
        If Me.oLanguage Is Nothing Then
            ...
            If oPassport IsNot Nothing Then
                Me.oLanguage.SetLanguageReference("PortalService", GetPassport().Language.Key)
            Else
                Me.oLanguage.SetLanguageReference("PortalService", "ESP")
            End If
        End If
    End Sub
...
#Region "Methods"
    ...
    Public Overrides Sub UpdateStateInfo(ByVal Ex As Exception, Optional ByVal strUbication As String = "")
        ...
        Me.intResult = GuiStateResultEnum.Exception
    End Sub
    ...
    Public Shadows Function Audit(ByVal _Action As Audit.Action, ByVal _ObjectType As Audit.ObjectType, ByVal _ObjectName As String, ByVal _Parameters As DataTable, ByVal _SessionID As Integer) As Integer
