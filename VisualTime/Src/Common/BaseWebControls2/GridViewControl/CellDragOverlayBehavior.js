...
Robotics.CellDragOverlayBehavior = function (element) {
    Robotics.CellDragOverlayBehavior.initializeBase(this, [element]);
    this._dataType = "_tableCell";
}

Robotics.CellDragOverlayBehavior.prototype = {
    initialize: function () {
        Robotics.CellDragOverlayBehavior.callBaseMethod(this, 'initialize');
    ...
    dispose: function () {
        ...
        Robotics.CellDragOverlayBehavior.callBaseMethod(this, 'dispose');
        this._disposed = true;
    },
...
Robotics.CellDragOverlayBehavior.descriptor = {
    properties: [{ name: 'gridViewUniqueID', type: String },
    { name: 'rowIndex', type: Number },
    { name: 'colIndex', type: Number },
    { name: 'UniqueID', type: String }]
}
Robotics.CellDragOverlayBehavior.registerClass('Robotics.CellDragOverlayBehavior', Sys.UI.Control, Sys.Preview.UI.IDragSource, Sys.Preview.UI.IDropTarget);
