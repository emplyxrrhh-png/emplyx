...
#Region "Declarations - Constructor"
        ...
        Private mvarJobPerformance As roPerformance
        ...
        Public Sub New()
            Me.mvarID = -1
            Me.mvarJobPerformance = New roPerformance()
        End Sub

        Public Sub New(ByVal _State As roJobState)
            Me.oState = _State
            Me.mvarJobPerformance = New roPerformance(Me.oState)
            Me.mvarID = -1
        End Sub
...
#Region "Methods"
        ...
        Public Function Load(Optional ByVal GetPerformance As String = "", Optional ByVal bolFromPunchID As Boolean = False) As Boolean
            '
            ...
            Try
                ...
                If rdPositioned.Rows.Count = 1 Then
                    ...
                    If GetPerformance <> "NO" Then mvarJobPerformance.CalculatedPerformance()
                    ...
                    If mvarIsQualityJob Then
                        Me.mvarQualityFields = New roJobQualityFields(Me.oState)
            ...
            Catch ex As DbException
                Me.oState.UpdateStateInfo(ex, "roJob::Load")
                mvarID = 0
                bolRet = False
        ...
        Public Sub GetTeoricAmount_Time(ByRef TeoricTime As Double, ByRef TeoricPieces As Double)
            '
        ...
        Private Sub FindAmountOrder(ByRef Amount As Double)
            '
            ...
            Try
                ...
                ads = Nothing
            Catch ex As Exception
                Me.oState.UpdateStateInfo(ex, "roJob::FindAmountOrder :")
            End Try
        End Sub

        Private Function GetPieces() As Boolean()
            ...
            Try
                ...
                Dim tb As DataTable = CreateDataTable("@SELECT# IsUsed FROM sysroPieceTypes WHERE [ID] > 0 ORDER BY [ID]", )
                ...
                Next
            Catch ex As Exception
                Me.oState.UpdateStateInfo(ex, "roJob::GetPieces :")
            End Try
        ...
        Public Function UpdateStartDate(ByVal xStartDate As Date) As Boolean
            ...
            Try
                ...
                End If
            Catch ex As DbException
                Me.oState.UpdateStateInfo(ex, "roJob::UpdateStartDate :")
            Catch ex As Exception
                Me.oState.UpdateStateInfo(ex, "roJob::UpdateStartDate :")
            Finally
        ...
        Public Function UpdateMachine(ByVal intIDMachine As Integer) As Boolean
            ...
            If Me.mvarIDMachine = 0 AndAlso Me.mvarAskMachine = 1 Then
                ...
                Try
                    ...
                    End If
                Catch ex As DbException
                    Me.oState.UpdateStateInfo(ex, "roJob::UpdateMachine :")
                Catch ex As Exception
                    Me.oState.UpdateStateInfo(ex, "roJob::UpdateMachine :")
                Finally
        ...
        Public Function HasMoves() As Boolean
            ...
            Try
                ...
                End If
            Catch ex As DbException
                Me.oState.UpdateStateInfo(ex, "roJob::HasMoves :")
            Catch ex As Exception
                Me.oState.UpdateStateInfo(ex, "roJob::HasMoves :")
            Finally
        ...
        Public Function AutomaticPreparationIncidence() As Integer
            ...
            If Not Me.HasMoves() AndAlso Me.PreparationTime > 0 Then
                ...
                If oSettings.GetVTSetting(eKeys.AutomaticPreparation) Then ' Está configurada la opción de incidencia de preparación automàtica
                    ...
                    Try
                        ...
                        End If
                    Catch ex As DbException
                        Me.oState.UpdateStateInfo(ex, "roJob::AutomaticPreparationIncidence  :")
                    Catch ex As Exception
                        Me.oState.UpdateStateInfo(ex, "roJob::AutomaticPreparationIncidence  :")
                    Finally
        ...
        Public Function GetTotalPieces() As Double
            ...
            Try
                ...
                End If
            Catch ex As DbException
                Me.oState.UpdateStateInfo(ex, "roJob::GetTotalPieces  :")
            Catch ex As Exception
                Me.oState.UpdateStateInfo(ex, "roJob::GetTotalPieces  :")
            Finally
        ...
        Public Function GetJobOrder(ByRef strIDOrder As String, ByRef strOrderName As String) As Boolean
            ...
            Try
                ...
                End If
            Catch ex As DbException
                Me.oState.UpdateStateInfo(ex, "roJob::GetJobOrder  :")
            Catch ex As Exception
                Me.oState.UpdateStateInfo(ex, "roJob::GetJobOrder  :")
            Finally
...
#Region "Helper methods"
        ...
        Public Shared Function GetActiveOrders(ByVal _State As roJobState) As DataTable
            ...
            Catch ex As DbException
                _State.UpdateStateInfo(ex, "roJob::GetActiveOrders :")
            Catch ex As Exception
                _State.UpdateStateInfo(ex, "roJob::GetActiveOrders :")
            Finally
        ...
        Public Shared Function GetJobsFromOrder(ByVal strIDOrder As String, ByVal _State As roJobState) As DataTable
            ...
            Try
                ...
                da.Fill(tbRet)
            Catch ex As DbException
                _State.UpdateStateInfo(ex, "roJob::GetJobsFromOrder :")
            Catch ex As Exception
                _State.UpdateStateInfo(ex, "roJob::GetJobsFromOrder :")
            Finally
