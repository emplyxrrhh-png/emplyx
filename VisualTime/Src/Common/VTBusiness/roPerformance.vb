...
#Region "Methods"
        ...
        Public Function CalculatedPerformance() As Boolean
            ...
            Catch ex As DbException
                Me.oState.UpdateStateInfo(ex, "roPerformance::CalculatedPerformance :")
                bolRet = False
                InitValues()
        ...
        Public Function CalculatedPerformanceEx() As Boolean
            'Calculamos el Rendimiento de una fase o de la orden
            'dependiento de los criterios de selección
            '--> (Rendimiento Actual o entre fechas)
            '--> (Rendimiento Piezas buenas Actual o entre fechas)
            ...
            Try
                ...
                End If
            Catch ex As DbException
                Me.oState.UpdateStateInfo(ex, "roPerformance::CalculatedPerformanceEx :")
                bolRet = False
                InitValues()
            Catch ex As Exception
                Me.oState.UpdateStateInfo(ex, "roPerformance::CalculatedPerformanceEx :")
        ...
        Private Sub FindTypePiece(ByVal TypePiece As Integer, ByRef CountPiece As Boolean, ByRef ToPerformanceType As Boolean)
            ...
            Try
                ...
                End If
            Catch ex As DbException
                Me.oState.UpdateStateInfo(ex, "roPerformance::FindTypePiece :")
            Catch ex As Exception
                Me.oState.UpdateStateInfo(ex, "roPerformance::FindTypePiece :")
            End Try
        ...
        Private Sub FindJobDetails(ByVal IDJob As Double, ByRef PieceTimeJob As Double, ByRef PreparationTime As Double, ByRef UnitPieces As Double)
            ...
            Try
                ...
                End If
            Catch ex As DbException
                Me.oState.UpdateStateInfo(ex, "roPerformance::FindJobDetails :")
            Catch ex As Exception
                Me.oState.UpdateStateInfo(ex, "roPerformance::FindJobDetails :")
            End Try
