...
Namespace CostCenter
    ...
    Public Class roCostCenterState
...
#Region "Declarations - Constructor"
        ...
        Public Sub New()
            MyBase.New("VTBusiness.CostCenter", "CostCentersService")
            Me.intResult = CostCenterResultEnum.NoError
        End Sub

        Public Sub New(ByVal _IDPassport As Integer)
            MyBase.New("VTBusiness.CostCenter", "CostCentersService", _IDPassport)
            Me.intResult = CostCenterResultEnum.NoError
        End Sub

        Public Sub New(ByVal _IDPassport As Integer, ByVal _Context As System.Web.HttpContext)
            MyBase.New("VTBusiness.CostCenter", "CostCentersService", _IDPassport, _Context)
            Me.intResult = CostCenterResultEnum.NoError
        End Sub

        Public Sub New(ByVal _IDPassport As Integer, ByVal _ClientAddress As String)
            MyBase.New("VTBusiness.CostCenter", "CostCentersService", _IDPassport, , _ClientAddress)
            Me.intResult = CostCenterResultEnum.NoError
        End Sub

        Public Sub New(ByVal _IDPassport As Integer, ByVal _Context As System.Web.HttpContext, ByVal _ClientAddress As String)
            MyBase.New("VTBusiness.CostCenter", "CostCentersService", _IDPassport, _Context, _ClientAddress)
            Me.intResult = CostCenterResultEnum.NoError
        End Sub
