...
''' <summary>
''' Deprecated class. Use VTBase.Extensions.roEncrypt instead
''' </summary>
Public Class roEncrypt
    ...
    'Private Shared ReadOnly Property KeyRoler() As Byte()
    '    Get
    '        Dim ProductID = "70922-3628"
    ...
    Private Shared ReadOnly Property CustomKey(ByVal customKeyValue As String) As Byte()
        Get
            Dim ProductID = customKeyValue
            Dim slt(8) As Byte
            Dim keyBytes As New Rfc2898DeriveBytes(ProductID, slt)
            Return keyBytes.GetBytes(24)
        End Get
    ...
    'Public Shared Function DecryptRoler(toDecrypt As Byte()) As Byte()
    '    Return Transform(toDecrypt, desCriptoService.CreateDecryptor(KeyRoler, Vector))
    'End Function
    ...
    Public Shared Function Decrypt(toDecrypt As Byte()) As Byte()
        ...
        Catch ex As CryptographicException
            Try
                Dim oParamValue = New Base.VTBusiness.Common.AdvancedParameter.roAdvancedParameter("CustomDecryptKey", New Base.VTBusiness.Common.AdvancedParameter.roAdvancedParameterState)
                If oParamValue.Value <> String.Empty Then
                    Return Transform(toDecrypt, desCriptoService.CreateDecryptor(CustomKey(oParamValue.Value), Vector))
                Else
