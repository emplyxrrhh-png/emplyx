...
Public Class roBotRule_Copy_Employee_Permissions
    Inherits roBotRuleManager

    Private idEmployeeSource As Integer = -1

    Public Sub New()
        MyBase.New(BotRuleTypeEnum.CopyEmployeePermissions)
    End Sub
    ...
    Protected Overrides Function ExecuteRuleSpecific() As Boolean
        ...
        Try
            ...
            If Me.oParameters IsNot Nothing AndAlso Me.oParameters.ContainsKey(BotRuleParameterEnum.DestinationEmployee) AndAlso GetIdSourceEmployee() > 0 Then
                ...
                lstEmployees.Add(roTypes.Any2Integer(Me.oParameters(BotRuleParameterEnum.DestinationEmployee)))
                bRet = roEmployeeSupport.SetAppConfigurationToEmployees(lstEmployees, "Employees", oState, GetIdSourceEmployee)

                If bRet Then bRet = roEmployeeSupport.SetPermissionsToEmployees(lstEmployees, "Employees", oState, GetIdSourceEmployee)
