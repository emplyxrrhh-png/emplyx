...
AS
select p.action, p.DateTime, p.TimeStamp as AuditPunchDate, p.IDPassport, sp.Name as UserName, p.actualType, p.IDTerminal, p.Source as punchSource, t.Description as terminalDescription, t.Type as terminalType, ISNULL(t.Other,'') as terminalOther, eg.EmployeeName, p.IDEmployee, eg.FullGroupName, pc.IDPunch as punchCapture, p.isNotReliable, p.inTelecommute, (SELECT TOP 1 Value FROM EmployeeUserFieldValues  
...
UPDATE sysroParameters SET Data='1002' WHERE ID='DBVersion'
GO
