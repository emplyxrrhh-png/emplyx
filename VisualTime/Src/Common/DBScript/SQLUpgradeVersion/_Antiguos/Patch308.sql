-- Actualizar las vistas de analitica con el nombre de grupo completo
ALTER VIEW [dbo].[sysroScheduleCube1]
 ...
 SELECT     TOP (100) PERCENT CAST(dbo.DailyAccruals.IDEmployee AS varchar) + '-' + CAST(dbo.DailyAccruals.IDConcept AS varchar) 
                       ...
                       dbo.sysroEmployeeGroups.GroupName,dbo.sysroEmployeeGroups.FullGroupName, dbo.Employees.Name AS EmployeeName, dbo.Concepts.Name AS ConceptName, dbo.DailyAccruals.Date, 
 ...
 GROUP BY dbo.DailyAccruals.IDEmployee, dbo.sysroEmployeeGroups.IDGroup, dbo.EmployeeContracts.IDContract, dbo.DailyAccruals.IDConcept, dbo.Concepts.Name, 
                       dbo.sysroEmployeeGroups.GroupName, dbo.sysroEmployeeGroups.FullGroupName, dbo.Employees.Name, dbo.DailyAccruals.Date, MONTH(dbo.DailyAccruals.Date), YEAR(dbo.DailyAccruals.Date), 
...
GO
 ...
 SELECT     CAST(dbo.sysroEmployeesShifts.IDEmployee AS varchar) + '-' + CAST(dbo.sysroEmployeeGroups.IDGroup AS varchar) 
                       ...
                       dbo.sysroEmployeesShifts.IDEmployee, dbo.sysroEmployeeGroups.IDGroup, dbo.EmployeeContracts.IDContract, dbo.sysroEmployeeGroups.GroupName, dbo.sysroEmployeeGroups.FullGroupName, 
 ...
 GROUP BY dbo.sysroEmployeesShifts.IDEmployee, dbo.sysroEmployeeGroups.GroupName, dbo.sysroEmployeeGroups.FullGroupName, dbo.Employees.Name, dbo.sysroEmployeesShifts.ShiftName, 
...
GO
 ...
 SELECT     CONVERT(varchar(10), dbo.DailySchedule.IDEmployee, 120) + '-' + CAST(dbo.EmployeeGroups.IDGroup AS varchar) 
                       ...
                       dbo.Employees.Name AS EmployeeName, dbo.Groups.Name AS GroupName, dbo.GetFullGroupPathName(dbo.Groups.ID) AS FullGroupName
 ...
 GROUP BY dbo.DailySchedule.IDEmployee, dbo.DailySchedule.Date, dbo.sysroDailyIncidencesDescription.Description, dbo.TimeZones.Name, dbo.Causes.Name, 
                       ...
                       THEN Shifts.Name ELSE Shifts_1.Name END, dbo.Employees.Name, dbo.Groups.Name, dbo.GetFullGroupPathName(dbo.Groups.ID), DATEPART(wk, dbo.DailySchedule.Date), DATEPART(dy, 
...
GO
-- Fin Actualizar las vistas de analitica con el nombre de grupo completo

-- Actualizamos versión de BBDD
UPDATE sysroParameters SET Data='308' WHERE ID='DBVersion'
GO
