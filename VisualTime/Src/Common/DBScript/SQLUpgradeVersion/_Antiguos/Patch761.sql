...
DROP PROCEDURE IF EXISTS [dbo].[Analytics_Access]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_AccessPlates]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_AccessPlates]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_Authorizations]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_Biometric]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_Concepts]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_CostCenters]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_CostCenters_ActualStatus]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_CostCenters_Detail]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_Incidences]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_Punches]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_Requests_CostCenters]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_Requests_Schedule]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_Requests_Tasks]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_Schedule]
GO

DROP PROCEDURE IF EXISTS [dbo].[Analytics_Tasks]
GO
...
UPDATE sysroParameters SET Data='761' WHERE ID='DBVersion'
GO
