 ...
 BEGIN
	CREATE TABLE #EmployeesTable
  	...
  	SET @sql = 'INSERT INTO #EmployeesTable 
  				...
  				WHERE Employees.RiskControlled = 1 AND sysrovwAllEmployeeGroups.BeginDate <= CONVERT(smalldatetime,''' + @Date + ''',120)
  					AND sysrovwAllEmployeeGroups.EndDate >= CONVERT(smalldatetime,''' + @Date + ''',120)'
...
UPDATE dbo.sysroParameters SET Data='377' WHERE ID='DBVersion'
GO
