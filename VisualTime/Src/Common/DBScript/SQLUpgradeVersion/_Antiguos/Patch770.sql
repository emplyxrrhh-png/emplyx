DROP PROCEDURE IF EXISTS [dbo].[Report_auditoria_fichajes]
GO
CREATE PROCEDURE [dbo].[Report_auditoria_fichajes]
...
UPDATE sysroParameters SET Data='770' WHERE ID='DBVersion'
GO
