...
dbo.DailyAccruals.ExpiredDate, dbo.DailyAccruals.BeginPeriod, dbo.DailyAccruals.EndPeriod, StartEnjoymentDate, DefaultQuery, dbo.DailyCauses.IDCause
UNION
SELECT
...
UPDATE sysroParameters SET Data='938' WHERE ID='DBVersion'
GO
