  ALTER FUNCTION [dbo].[GetRequestPassportPermission]
       ...
       BEGIN
 		...
 		END    
			...
			SET @Permission = (select Permission from sysroPermissionsOverFeatures where PassportID = @IDParentPassport  and featureID = @featureAlias)
...
GO
UPDATE sysroParameters SET Data='579' WHERE ID='DBVersion'
GO
