...
INNER JOIN sysroPassports_Categories AS PassportCategory ON PassportCategory.IDPassport = sysroPassports.Id AND PassportCategory.IDCategory = sysroRequestType.IDCategory
...
UPDATE sysroParameters SET Data='780' WHERE ID='DBVersion'
GO
