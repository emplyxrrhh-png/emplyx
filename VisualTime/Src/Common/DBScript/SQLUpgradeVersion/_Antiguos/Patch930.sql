...
AS  
	...
	SET @SQLString = 'SELECT DISTINCT ' + @idFieldName + ' As Id FROM ' + @entityName + ' WHERE ' + @idFieldName + ' IN(' + @source + ')'
...
UPDATE sysroParameters SET Data='930' WHERE ID='DBVersion'
GO
