INSERT [dbo].[sysroGUI] ([IDPath], [LanguageReference], [URL], [IconURL], [Type], [Parameters], [RequiredFeatures], [SecurityFlags], [Priority], [AllowedSecurity], [RequiredFunctionalities]) VALUES (N'Portal\Configuration\PortalConfiguration', N'PortalConfiguration', N'PortalConfiguration', N'Portal48.png', NULL, NULL, NULL, NULL, 2203, NULL, N'U:Administration.Options.General=Read')
GO
UPDATE sysroLiveAdvancedParameters SET Value = 17 WHERE ParameterName='VTPortalApiVersion'
GO

ALTER TABLE [dbo].[sysrogui] ADD [Edition] NVARCHAR(200) DEFAULT ''
GO

ALTER TABLE [dbo].[sysroGUI_Actions] ADD [Edition] NVARCHAR(200) DEFAULT ''
GO

ALTER TABLE [dbo].[sysroFeatures] ADD [Edition] NVARCHAR(200) DEFAULT ''
GO

ALTER TABLE [dbo].[ImportGuides] ADD [Edition] NVARCHAR(200) DEFAULT ''
GO

ALTER TABLE [dbo].[ExportGuides] ADD [Edition] NVARCHAR(200) DEFAULT ''
GO

ALTER PROCEDURE dbo.WebPortal_Gui_SelectByApplication  
  (  
...
GO
  ...
  ALTER PROCEDURE [dbo].[UsersAdmin_Features_List]
  	(
  ...
  AS
    IF @edition = '' 
  	...
  	ELSE
  		...
  		FROM sysroFeatures f
  		WHERE (Type = '' OR 
  			Type = @featureType) AND CHARINDEX(@edition,Edition)> 0
  		ORDER BY Name
  	RETURN
GO

ALTER TABLE [dbo].[DailySchedule] ADD StartFlexible1 datetime null
GO
ALTER TABLE [dbo].[DailySchedule] ADD StartFlexibleBase datetime null
GO
ALTER TABLE [dbo].[DailySchedule] ADD StartFlexibleUsed datetime null
GO
ALTER TABLE [dbo].[DailySchedule] ADD EndFlexible1 datetime null
GO
ALTER TABLE [dbo].[DailySchedule] ADD EndFlexibleBase datetime null
GO
ALTER TABLE [dbo].[DailySchedule] ADD EndFlexibleUsed datetime null
GO
ALTER TABLE [dbo].[DailySchedule] ADD ShiftName1 NVARCHAR(max) null
GO
ALTER TABLE [dbo].[DailySchedule] ADD ShiftNameBase NVARCHAR(max) null
GO
ALTER TABLE [dbo].[DailySchedule] ADD ShiftNameUsed NVARCHAR(max) null
GO
ALTER TABLE [dbo].[DailySchedule] ADD ShiftColor1 INT null
GO
ALTER TABLE [dbo].[DailySchedule] ADD ShiftColorBase INT null
GO
ALTER TABLE [dbo].[DailySchedule] ADD ShiftColorUsed INT null
GO

--Nombre de horario flexible para starter
...
UPDATE sysroParameters SET Data='524' WHERE ID='DBVersion'
GO
