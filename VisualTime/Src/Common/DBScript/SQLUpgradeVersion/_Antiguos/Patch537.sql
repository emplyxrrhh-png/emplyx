UPDATE [dbo].[GeniusCustomReportCheckboxes]
   SET [Order] = [Order] + 1
 WHERE [Order] > 4
GO
...
INSERT INTO [dbo].[GeniusViews]
     ...
     VALUES
           ...
           ,'P'
           ,1
           ,'20220411','',	0,	'20220411','20220411',	'{"slice":{"reportFilters":[{"uniqueName":"IDContract"},{"uniqueName":"CurrentEmployee"}],"rows":[{"uniqueName":"FullGroupName"},{"uniqueName":"GroupName"},{"uniqueName":"DiningTurn"},{"uniqueName":"EmployeeName"}],"columns":[{"uniqueName":"[Measures]"}],"measures":[{"uniqueName":"Cantidad (Usuario)","formula":"count(\"EmployeeName\")"}],"expands":{"expandAll":true}},"options":{"grid":{"type":"classic"}},"creationDate":"2022-04-11T11:15:42.091Z"}','','','','{"IncludeZeros":true,"IncludeZeroBusinessCenter":true,"LanguageKey":"ESP","RequestTypes":""}',	'Genius_Dining_Punches(@initialDate,@endDate,@idpassport,@employeeFilter,@userFieldsFilter)',	'Calendar',	'Calendar.Analytics',	NULL,	NULL)
GO
...
INSERT INTO [dbo].[GeniusViews]
     ...
     VALUES
           ...
           ,'P'
           ,1
           ,'20220411','',	0,	'20220411','20220411',	'{"slice":{"reportFilters":[{"uniqueName":"IDContract"},{"uniqueName":"CurrentEmployee"}],"rows":[{"uniqueName":"FullGroupName"},{"uniqueName":"GroupName"},{"uniqueName":"EmployeeName"},{"uniqueName":"Date_ToDateString"},{"uniqueName":"Time"},{"uniqueName":"Type"}],"columns":[{"uniqueName":"[Measures]"}],"measures":[{"uniqueName":"Cantidad (Usuario)","formula":"count(\"EmployeeName\")"}],"expands":{"expandAll":true}},"options":{"grid":{"type":"classic","showTotals":"off"}},"creationDate":"2022-04-11T12:10:58.723Z"}','','','','{"IncludeZeros":true,"IncludeZeroBusinessCenter":true,"LanguageKey":"ESP","RequestTypes":""}',	'Genius_Dining_Punches(@initialDate,@endDate,@idpassport,@employeeFilter,@userFieldsFilter)',	'Calendar',	'Calendar.Analytics',	NULL,	NULL)
GO
...
UPDATE sysroParameters SET Data='537' WHERE ID='DBVersion'
GO