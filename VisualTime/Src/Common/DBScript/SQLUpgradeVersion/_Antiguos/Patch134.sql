-- Elimina tablas de producción previas a esta version (son una beta)
...
-- Crea nuevas tablas de producción y relaciones
...
-- No permite Nulls en fechas de inicio y fin de conceptos
ALTER TABLE [Concepts] ALTER COLUMN [BeginDate] SMALLDATETIME NOT NULL
GO
ALTER TABLE [Concepts] ALTER COLUMN [FinishDate] SMALLDATETIME NOT NULL
GO

-- Elimina la causa 3 (Descansos) si no está siendo usada porque no sirve para nada
DELETE FROM [Causes] WHERE ID=3
GO

-- Crea causa 4 para horas teoricas
DELETE FROM [Causes] WHERE ID=4
GO
INSERT INTO Causes(ID,Name,Description,RoundingBy,ShortName) VALUES(4,'Horas Teoricas','Horas que debería haber trabajado según se indica en el horario del empleado',1,'HTR')
GO

-- Actualiza versión de la base de datos
UPDATE sysroParameters SET Data='134' WHERE ID='DBVersion'
GO
