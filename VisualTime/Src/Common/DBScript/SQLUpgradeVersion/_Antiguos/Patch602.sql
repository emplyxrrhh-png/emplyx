...
CREATE PROCEDURE [dbo].[Genius_TelecommutingAgreementCompliance]
   ...
   CASE WHEN sysrovwEmployeeTelecommuting.TelecommuteOptionalPlanned <> 0 AND (sysrovwEmployeeTelecommuting.TelecommuteOptionalExpected = 1 OR sysrovwEmployeeTelecommuting.TelecommuteOptionalPlanned = 1) THEN 'Opcional' 
   WHEN sysrovwEmployeeTelecommuting.TelecommutePlanned <> 0 AND (sysrovwEmployeeTelecommuting.TelecommuteExpected = 1 OR sysrovwEmployeeTelecommuting.TelecommutePlanned = 1) THEN 'Teletrabajo' 
...
UPDATE sysroParameters SET Data='602' WHERE ID='DBVersion'
GO
