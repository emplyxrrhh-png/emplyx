...
--Histórico de contraseñas mínimo 24
UPDATE [dbo].[sysroSecurityParameters] SET PreviousPasswordsStored = 24 WHERE IDPassport = 0 AND PreviousPasswordsStored < 24
GO

UPDATE sysroParameters SET Data='0' WHERE ID='DXVersion'
GO

UPDATE sysroParameters SET Data='612' WHERE ID='DBVersion'
GO
