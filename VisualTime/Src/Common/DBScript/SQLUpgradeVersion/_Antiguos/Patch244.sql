/* Modificación de la función sql, debido a que con el live no recogia correctamente los grupos */
...
/* Agrandamos el campo path de la tabla groups */
ALTER TABLE Groups ALTER COLUMN Path nvarchar(100) null
GO

/* ***************************************************************************************************************************** */
-- Actualizamos versión de BBDD
UPDATE sysroParameters SET Data='244' WHERE ID='DBVersion'
GO
