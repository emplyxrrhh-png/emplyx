...
update [dbo].[sysroGroupFeatures_PermissionsOverFeatures] set Permision = 0 where IDFeature = 1621 and IDGroupFeature in (select id from sysroGroupFeatures where name not like '%@@ROBOTICS@@%')
GO

UPDATE sysroParameters SET Data='0' WHERE ID='DXVersion'
GO

UPDATE sysroParameters SET Data='811' WHERE ID='DBVersion'
GO
