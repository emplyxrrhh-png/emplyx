...
<Serializable()>
<DataContract>
Public Class roLanguageLocalCustom
    ...
    Private oTextList As CustomLanguageFile
    Private oTextDictList As CustomLanguageFile
    ...
    Public Function Translate(ByVal TextKey As String, ByVal Scope As String) As String
        ...
        ' Traduzco el TEXTO
        strTranslation = FindLanguageText(TextKey & ".roText", String.Empty)

        If strTranslation <> String.Empty Then
    ...
    Private Function FindLanguageText(ByVal Key As String, ByVal DefaultValue As String, Optional ByVal FromDic As Boolean = False) As String
        ...
        Dim oAuxTextList As CustomLanguageFile
    ...
    Public Function Keyword(ByVal key As String) As String
        ...
        ' Poner primera letra en mayúscula si es necesario
        ''If key <> "" And strRet <> "" Then
        ''    If key.Substring(0, 1) = key.Substring(0, 1).ToUpper Then
        ''        strRet = strRet.Substring(0, 1).ToUpper & strRet.Substring(1)
        ''    End If
        ''End If
    ...
    Public Function GetLanguage(ByVal LanguageReference As String, ByVal LanguageKey As String, ByVal Scope As String) As CustomLanguageFile
        Dim oTextsArray As New CustomLanguageFile
        Dim strLanguagePath As String
        Dim strFile As String = String.Empty
        Dim strCustomFile As String = String.Empty
        Dim strLine As String
        Dim bIsCustomFile As Boolean = LanguageKey.Contains(".CUST")
        ...
        If Not sCustomFileContent Then
            ...
            If InStr(LanguageKey, ".LNG") > 0 Then
            ...
            ElseIf InStr(LanguageKey, ".DIC") > 0 Then
            ...
            'If InStr(LanguageKey, ".LNG") > 0 InStr(LanguageKey, ".DIC") > 0 Then
            '    If Not bIsCustomFile Then strCustomFile = LanguageReference & "." & LanguageKey.Split(".")(0) & ".CUST." & LanguageKey.Split(".")(1)
            'Else
            '    If Not bIsCustomFile Then strCustomFile = LanguageReference & "." & LanguageKey & ".CUST.LNG"
            'End If
