VTPortal.externalWork = function (params) {
    ...
    var loadRequest = function () {
        new WebServiceRobotics(function (result) {
            if (result.Status == window.VTPortalUtils.constants.OK.value) {
                ...
                iHour(moment(result.strHours, "HH:mm").toDate());
    ...
    function saveRequest() {
        ...
        var onWSResult = function (result) {
            if (result.Status == window.VTPortalUtils.constants.OK.value) {
                VTPortal.roApp.redirectAtRequestList(4);
                VTPortalUtils.utils.notifyMesage(i18nextko.i18n.t("roRequestSaved"), 'success', 2000);
            } else {
                var onContinue = function () {
                    wsRobotics.saveExternalWork(moment(iDate()), moment(iHour()).format('HH:mm'), remarks(), reqValue1() != null ? reqValue1() : '-1', true);
                }
        ...
        wsRobotics.saveExternalWork(moment(iDate()), moment(iHour()).format('HH:mm'), remarks(), reqValue1() != null ? reqValue1() : '-1', false);
    }
    ...
    var viewModel = {
        ...
        viewShown: viewShown,
        title: i18nextko.t('roRequestType_ExternalWorkResumePart'),
        lblRemarks: i18nextko.t('roRequestRemarksLbl'),
        lblRequestValue1: i18nextko.t('roRequestCauseLbl'),
        lblInitialDate: i18nextko.t('roRequestDateLbl'),
        lblInitialHour: i18nextko.t('roRequestDurationLbl'),
        ...
        btnApprove: {
            onClick: function () { VTPortalUtils.utils.approveRefuseRequest(requestId(), 4, true); },
            text: '',
        ...
        btnRefuse: {
            onClick: function () { VTPortalUtils.utils.approveRefuseRequest(requestId(), 4, false); },
            text: '',
