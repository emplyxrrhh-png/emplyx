            ...
            onItemClick: function (info) {
                if (info.itemData.hasAction) {
                    if (VTPortal.roApp.db.settings.ApiVersion >= VTPortalUtils.apiVersion.NewRequests) {
                        if (info.itemData.IdRequestType != 7 && info.itemData.IdRequestType != 6 && info.itemData.IdRequestType != 9 &&
                            info.itemData.IdRequestType != 13 && info.itemData.IdRequestType != 2 && info.itemData.IdRequestType != 10
                            && info.itemData.IdRequestType != 12) {
                        ...
                        switch (info.itemData.IdRequestType) {
                            ...
                            case 15:
                                ...
                                break;
                            case 16:
                                VTPortal.app.navigate('telecommute/' + info.itemData.Id);
                                break;
                        }
                    }
                    else {
