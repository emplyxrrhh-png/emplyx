VTPortal.configuration = function (params) {
    ...
    var profileUserFields = VTPortal.profileUserFields(),
        sharedPortalConfig = VTPortal.sharedPortalConfig();
    ...
    var profileTitle = ko.computed(function () {
        switch (curSelectedView()) {
            case 1:
                ...
                break;
            case 2:
                return i18nextko.i18n.t('roSharedPortalConfig');
                break;
        }
    }, this);
    ...
    function viewShown() {
        ...
        sharedPortalConfig.modelIsReady(false);
    ...
    var viewModel = {
        ...
        sharedPortalConfigBlock: sharedPortalConfig,
