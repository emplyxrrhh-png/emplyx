VTPortal.statusHeader = function (params) {
    ...
    var requests = ko.computed(function () {
        if (VTPortal.roApp.userAlerts() != null && typeof VTPortal.roApp.userAlerts() != 'undefined') {
            return VTPortal.roApp.userAlerts().ScheduleStatus.RequestAlerts.length;
        } else return '';
    });

    var forgottenPunches = ko.computed(function () {
        if (VTPortal.roApp.userAlerts() != null && typeof VTPortal.roApp.userAlerts() != 'undefined') {
            return VTPortal.roApp.userAlerts().ScheduleStatus.IncompletePunches.length;
        } else return '';
    });
