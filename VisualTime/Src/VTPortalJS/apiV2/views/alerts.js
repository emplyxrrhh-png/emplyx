VTPortal.alerts = function (params) {
    ...
    var generateAlerts = function () {
        ...
        let buildAlertsDS = function () {
            var alerts = VTPortal.roApp.userAlerts().ScheduleStatus;
            ...
            if (alerts != null) {
                ...
                if (typeof alerts.ForecastDocuments != 'undefined') {
                    ...
                    for (var i = 0; i < alerts.ForecastDocuments.length; i++) {
                        ...
                        hasAction = false;
                        if (!VTPortal.roApp.isTimeGate() && alerts.ForecastDocuments[i].IDDocument <= 0) hasAction = true;

                        let alertDescription = alerts.ForecastDocuments[i].Description;
                        if (VTPortal.roApp.isTimeGate() && alerts.ForecastDocuments[i].IDDocument <= 0) alertDescription += ". " + i18nextko.i18n.t('WRONG_DEVICE');
        ...
        VTPortal.roApp.refreshEmployeeAlerts(buildAlertsDS);
    ...
    var viewModel = {
        ...
        listAlerts: {
            ...
            onItemClick: function (info) {
                VTPortal.roApp.db.settings.markForRefresh(['notifications','status']);
