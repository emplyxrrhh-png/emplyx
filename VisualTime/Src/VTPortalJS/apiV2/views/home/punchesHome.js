VTPortal.punchesHome = function (params) {
    var punchesDS = ko.observable(null);
    ...
    var punchesViewShown = function () {

        punchesDS(VTPortal.roApp.db.settings.getCacheDS('punches'));
        VTPortal.roApp.punchesDS(VTPortal.roApp.db.settings.getCacheDS('punches'));

        if (punchesDS() == null || window.VTPortalUtils.needToRefresh('punches')) getPunches();
    }
    ...
    var getPunches = function (e) {
        new WebServiceRobotics(function (result) {
            if (result.Status == window.VTPortalUtils.constants.OK.value) {
                ...
                VTPortal.roApp.db.settings.updateCacheDS('punches', result.Punches);
            } else {
                punchesDS([]);
